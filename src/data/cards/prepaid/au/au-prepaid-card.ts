...
export const auPrepaidCard: CardData = {
  id: "au-prepaid-card",
  name: "AU Small Finance Bank Prepaid Card",
  tagline: "Smart prepaid for digital spending",
  description: "The AU Small Finance Bank Prepaid Card is a convenient prepaid card for domestic transactions, online shopping, and ATM withdrawals.",
  bank: "AU Small Finance Bank", bankCode: "au", network: "Visa", cardType: "prepaid", tier: "Classic", variant: "AU Prepaid", usage: "Domestic", bin: "", material: "Plastic", colorScheme: "Orange and white", virtualCardAvailable: true,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "limits"], unverifiedFields: [], sourceUrls: ["https://www.aubank.in"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800 1200 1200", applyUrl: "https://www.aubank.in", lastUpdated: "2026-03-27",
};
