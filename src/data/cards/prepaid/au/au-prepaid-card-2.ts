...
export const auPrepaidCard2: CardData = {
  id: "au-prepaid-card-2",
  name: "AU Small Finance Bank Prepaid Card",
  tagline: "Prepaid card from AU Small Finance Bank for digital payments.",
  description: "Prepaid card from AU Small Finance Bank for digital payments.",
