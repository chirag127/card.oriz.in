...
export const stanchartPrepaidCard: CardData = {
  id: "stanchart-prepaid-card",
  name: "Standard Chartered Prepaid Card",
  tagline: "International bank prepaid for digital payments",
  description: "The Standard Chartered Prepaid Card is a convenient prepaid card for domestic transactions, online shopping, and ATM withdrawals.",
  bank: "Standard Chartered", bankCode: "stanchart", network: "Visa", cardType: "prepaid", tier: "Classic", variant: "SC Prepaid", usage: "Domestic", bin: "", material: "Plastic", colorScheme: "Blue and green", virtualCardAvailable: true,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "limits"], unverifiedFields: [], sourceUrls: ["https://www.sc.com/in"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800 345 5000", applyUrl: "https://www.sc.com/in", lastUpdated: "2026-03-27",
};
