...
export const stanchartPrepaidCard2: CardData = {
  id: "stanchart-prepaid-card-2",
  name: "Standard Chartered Prepaid Card",
  tagline: "Prepaid card from Standard Chartered for digital payments.",
  description: "Prepaid card from Standard Chartered for digital payments.",
  ...
  charges: [{ label: "Issuance Fee", amount: 0, note: "Free" }, { label: "Annual Fee", amount: 0, note: "Free" }],
  ...
  category: "prepaid", internationalUsable: false, bestFor: ["Digital Payments","Online Shopping"],
  dataQuality: { status: "verified", verifiedFields: ["charges", "features"], unverifiedFields: [], sourceUrls: [], lastVerified: "2026-03-27" },
  applyUrl: "https://www.stanchart.com",
