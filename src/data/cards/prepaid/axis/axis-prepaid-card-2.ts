...
export const axisPrepaidCard2: CardData = {
  id: "axis-prepaid-card-2",
  name: "Axis Bank Prepaid Card",
  tagline: "Prepaid card from Axis Bank for digital payments.",
  description: "Prepaid card from Axis Bank for digital payments.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "prepaid",
