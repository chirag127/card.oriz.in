...
export const yesPrepaidCard2: CardData = {
  id: "yes-prepaid-card-2",
  name: "Yes Bank Prepaid Card",
  tagline: "Prepaid card from Yes Bank for digital payments.",
  description: "Prepaid card from Yes Bank for digital payments.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "prepaid",
