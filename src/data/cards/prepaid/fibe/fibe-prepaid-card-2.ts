...
export const fibePrepaidCard2: CardData = {
  id: "fibe-prepaid-card-2",
  name: "Fibe Prepaid Card",
  tagline: "Prepaid card from Fibe for digital payments.",
  description: "Prepaid card from Fibe for digital payments.",
  bank: "Fibe",
  bankCode: "fibe",
  network: "Visa",
  cardType: "prepaid",
