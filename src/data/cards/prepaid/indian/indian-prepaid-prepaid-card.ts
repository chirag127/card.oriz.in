...
export const indianPrepaidPrepaidCard: CardData = {
  id: 'indian-prepaid-prepaid-card', name: 'Indian Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from Indian Bank', description: 'The Indian Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'Indian Bank', bankCode: 'indian', network: 'Visa', cardType: 'prepaid', tier: 'Prepaid', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
