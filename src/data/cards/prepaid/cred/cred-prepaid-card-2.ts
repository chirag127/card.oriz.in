...
export const credPrepaidCard2: CardData = {
  id: "cred-prepaid-card-2",
  name: "CRED Prepaid Card",
  tagline: "Prepaid card from CRED for digital payments.",
  description: "Prepaid card from CRED for digital payments.",
  bank: "CRED",
  bankCode: "cred",
  network: "Visa",
  cardType: "prepaid",
