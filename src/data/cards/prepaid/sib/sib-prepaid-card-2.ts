...
export const sibPrepaidCard2: CardData = {
  id: "sib-prepaid-card-2",
  name: "South Indian Bank Prepaid Card",
  tagline: "Prepaid card from South Indian Bank for digital payments.",
  description: "Prepaid card from South Indian Bank for digital payments.",
