...
export const cubPrepaidPrepaidCard: CardData = {
  id: 'cub-prepaid-prepaid-card', name: 'City Union Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from City Union Bank', description: 'The City Union Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'City Union Bank', bankCode: 'cub', network: 'Visa', cardType: 'prepaid', tier: 'Classic', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
