...
export const federalPrepaidCard2: CardData = {
  id: "federal-prepaid-card-2",
  name: "Federal Bank Prepaid Card",
  tagline: "Prepaid card from Federal Bank for digital payments.",
  description: "Prepaid card from Federal Bank for digital payments.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.federal.com",
