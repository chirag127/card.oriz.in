...
export const karnatakaPrepaidCard2: CardData = {
  id: "karnataka-prepaid-card-2",
  name: "Karnataka Bank Prepaid Card",
  tagline: "Prepaid card from Karnataka Bank for digital payments.",
  description: "Prepaid card from Karnataka Bank for digital payments.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.karnataka.com",
