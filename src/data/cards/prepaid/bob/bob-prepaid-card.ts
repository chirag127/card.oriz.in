...
export const bobPrepaidCard: CardData = {
  id: "bob-prepaid-card",
  name: "Bank of Baroda Prepaid Card",
  tagline: "Reliable prepaid for everyday spending",
  description: "The Bank of Baroda Prepaid Card is a convenient prepaid card that can be loaded with funds and used for domestic transactions, online shopping, and ATM withdrawals.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "Visa",
  cardType: "prepaid",
  ...
  customerCareNumber: "1800 102 4455",
