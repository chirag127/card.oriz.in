...
export const kotakPrepaidCard2: CardData = {
  id: "kotak-prepaid-card-2",
  name: "Kotak Mahindra Bank Prepaid Card",
  tagline: "Prepaid card from Kotak Mahindra Bank for digital payments.",
  description: "Prepaid card from Kotak Mahindra Bank for digital payments.",
