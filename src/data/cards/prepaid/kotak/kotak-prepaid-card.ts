...
export const kotakPrepaidCard: CardData = {
  id: "kotak-prepaid-card",
  name: "Kotak Mahindra Prepaid Card",
  tagline: "Load and spend with ease",
  description: "The Kotak Mahindra Prepaid Card is a versatile prepaid card that can be loaded with funds and used for domestic transactions. Ideal for gifting, travel, and controlled spending.",
  bank: "Kotak Mahindra Bank",
  bankCode: "kotak",
  network: "Visa",
  cardType: "prepaid",
  tier: "Classic",
  variant: "Kotak Prepaid",
  usage: "Domestic",
  bin: "",
  material: "Plastic",
