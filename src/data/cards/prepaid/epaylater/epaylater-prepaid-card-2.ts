...
export const epaylaterPrepaidCard2: CardData = {
  id: "epaylater-prepaid-card-2",
  name: "ePayLater Prepaid Card",
  tagline: "Prepaid card from ePayLater for digital payments.",
  description: "Prepaid card from ePayLater for digital payments.",
  bank: "ePayLater",
  bankCode: "epaylater",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.epaylater.com",
