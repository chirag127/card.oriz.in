...
export const tmbPrepaidPrepaidCard: CardData = {
  id: 'tmb-prepaid-prepaid-card', name: 'Tamilnad Mercantile Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from Tamilnad Mercantile Bank', description: 'The Tamilnad Mercantile Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'Tamilnad Mercantile Bank', bankCode: 'tmb', network: 'Visa', cardType: 'prepaid', tier: 'Classic', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
