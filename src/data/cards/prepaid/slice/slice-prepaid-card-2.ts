...
export const slicePrepaidCard2: CardData = {
  id: "slice-prepaid-card-2",
  name: "Slice Prepaid Card",
  tagline: "Prepaid card from Slice for digital payments.",
  description: "Prepaid card from Slice for digital payments.",
  bank: "Slice",
  bankCode: "slice",
  network: "Visa",
  cardType: "prepaid",
