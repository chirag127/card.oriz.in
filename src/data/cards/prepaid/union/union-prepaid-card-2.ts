...
export const unionPrepaidCard2: CardData = {
  id: "union-prepaid-card-2",
  name: "Union Bank of India Prepaid Card",
  tagline: "Prepaid card from Union Bank of India for digital payments.",
  description: "Prepaid card from Union Bank of India for digital payments.",
