...
export const idbiPrepaidPrepaidCard: CardData = {
  id: 'idbi-prepaid-prepaid-card', name: 'IDBI Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from IDBI Bank', description: 'The IDBI Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'IDBI Bank', bankCode: 'idbi', network: 'Visa', cardType: 'prepaid', tier: 'Prepaid', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
