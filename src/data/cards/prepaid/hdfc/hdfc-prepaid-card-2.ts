...
export const hdfcPrepaidCard2: CardData = {
  id: "hdfc-prepaid-card-2",
  name: "HDFC Bank Prepaid Card",
  tagline: "Prepaid card from HDFC Bank for digital payments.",
  description: "Prepaid card from HDFC Bank for digital payments.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "prepaid",
