...
export const moneytapPrepaidCard2: CardData = {
  id: "moneytap-prepaid-card-2",
  name: "MoneyTap Prepaid Card",
  tagline: "Prepaid card from MoneyTap for digital payments.",
  description: "Prepaid card from MoneyTap for digital payments.",
  bank: "MoneyTap",
  bankCode: "moneytap",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.moneytap.com",
