...
export const ringPrepaidCard2: CardData = {
  id: "ring-prepaid-card-2",
  name: "Ring Prepaid Card",
  tagline: "Prepaid card from Ring for digital payments.",
  description: "Prepaid card from Ring for digital payments.",
  bank: "Ring",
  bankCode: "ring",
  network: "Visa",
  cardType: "prepaid",
