...
export const naviPrepaidCard2: CardData = {
  id: "navi-prepaid-card-2",
  name: "Navi Prepaid Card",
  tagline: "Prepaid card from Navi for digital payments.",
  description: "Prepaid card from Navi for digital payments.",
  bank: "Navi",
  bankCode: "navi",
  network: "Visa",
  cardType: "prepaid",
