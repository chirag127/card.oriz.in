...
export const bandhanPrepaidPrepaidCard: CardData = {
  id: 'bandhan-prepaid-prepaid-card', name: 'Bandhan Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from Bandhan Bank', description: 'The Bandhan Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'Bandhan Bank', bankCode: 'bandhan', network: 'Visa', cardType: 'prepaid', tier: 'Prepaid', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.bandhan.com', lastUpdated: '2026-03-27',
};