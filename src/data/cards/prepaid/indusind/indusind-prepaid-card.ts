...
export const indusindPrepaidCard: CardData = {
  id: "indusind-prepaid-card",
  name: "IndusInd Bank Prepaid Card",
  tagline: "Flexible prepaid for digital payments",
  description: "The IndusInd Bank Prepaid Card is a versatile prepaid card that can be loaded with funds and used for domestic transactions, online shopping, and ATM withdrawals.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "Visa",
  cardType: "prepaid",
  tier: "Classic",
  variant: "IndusInd Prepaid",
  usage: "Domestic",
  bin: "",
  material: "Plastic",
