...
export const zestmoneyPrepaidCard2: CardData = {
  id: "zestmoney-prepaid-card-2",
  name: "ZestMoney Prepaid Card",
  tagline: "Prepaid card from ZestMoney for digital payments.",
  description: "Prepaid card from ZestMoney for digital payments.",
  bank: "ZestMoney",
  bankCode: "zestmoney",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.zestmoney.com",
