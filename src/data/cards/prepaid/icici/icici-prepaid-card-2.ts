...
export const iciciPrepaidCard2: CardData = {
  id: "icici-prepaid-card-2",
  name: "ICICI Bank Prepaid Card",
  tagline: "Prepaid card from ICICI Bank for digital payments.",
  description: "Prepaid card from ICICI Bank for digital payments.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "prepaid",
