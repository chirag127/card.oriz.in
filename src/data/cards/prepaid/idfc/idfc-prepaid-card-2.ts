...
export const idfcPrepaidCard2: CardData = {
  id: "idfc-prepaid-card-2",
  name: "IDFC First Bank Prepaid Card",
  tagline: "Prepaid card from IDFC First Bank for digital payments.",
  description: "Prepaid card from IDFC First Bank for digital payments.",
