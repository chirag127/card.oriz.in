...
export const kreditbeePrepaidCard2: CardData = {
  id: "kreditbee-prepaid-card-2",
  name: "KreditBee Prepaid Card",
  tagline: "Prepaid card from KreditBee for digital payments.",
  description: "Prepaid card from KreditBee for digital payments.",
  bank: "KreditBee",
  bankCode: "kreditbee",
  network: "Visa",
  cardType: "prepaid",
  ...
  applyUrl: "https://www.kreditbee.com",
