...
export const canaraPrepaidCard: CardData = {
  id: "canara-prepaid-card",
  name: "Canara Bank Prepaid Card",
  tagline: "Government bank prepaid for secure spending",
  description: "The Canara Bank Prepaid Card is a secure prepaid card for domestic transactions, online shopping, and ATM withdrawals. Suitable for controlled spending.",
  bank: "Canara Bank", bankCode: "canara", network: "RuPay", cardType: "prepaid", tier: "Classic", variant: "Canara Prepaid", usage: "Domestic", bin: "", material: "Plastic", colorScheme: "Orange and blue", virtualCardAvailable: false,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "limits"], unverifiedFields: [], sourceUrls: ["https://www.canarabank.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800 425 0018", applyUrl: "https://www.canarabank.com", lastUpdated: "2026-03-27",
};
