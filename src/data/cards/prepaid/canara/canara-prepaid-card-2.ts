...
export const canaraPrepaidCard2: CardData = {
  id: "canara-prepaid-card-2",
  name: "Canara Bank Prepaid Card",
  tagline: "Prepaid card from Canara Bank for digital payments.",
  description: "Prepaid card from Canara Bank for digital payments.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "Visa",
  cardType: "prepaid",
