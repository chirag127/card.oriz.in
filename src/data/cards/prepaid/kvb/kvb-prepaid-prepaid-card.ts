...
export const kvbPrepaidPrepaidCard: CardData = {
  id: 'kvb-prepaid-prepaid-card', name: 'Karur Vysya Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from Karur Vysya Bank', description: 'The Karur Vysya Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'Karur Vysya Bank', bankCode: 'kvb', network: 'Visa', cardType: 'prepaid', tier: 'Prepaid', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
