...
export const dcbPrepaidPrepaidCard: CardData = {
  id: 'dcb-prepaid-prepaid-card', name: 'DCB Bank Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from DCB Bank', description: 'The DCB Bank Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'DCB Bank', bankCode: 'dcb', network: 'Visa', cardType: 'prepaid', tier: 'Prepaid', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
