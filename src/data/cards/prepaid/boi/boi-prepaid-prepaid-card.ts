...
export const boiPrepaidPrepaidCard: CardData = {
  id: 'boi-prepaid-prepaid-card', name: 'Bank of India Prepaid Prepaid Card', tagline: 'A prepaid prepaid card from Bank of India', description: 'The Bank of India Prepaid Prepaid Card offers rewards and convenience for daily transactions.', bank: 'Bank of India', bankCode: 'boi', network: 'Visa', cardType: 'prepaid', tier: 'Classic', variant: 'Prepaid', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
