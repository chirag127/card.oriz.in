...
export const amexBusinessGreenCreditCard: CardData = {
  id: "amex-business-green-credit-card",
  name: "American Express Business Green Credit Card",
  tagline: "Corporate credit card from American Express with rewards on all spends.",
  description: "Corporate credit card from American Express with rewards on all spends. The American Express Business Green Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "American Express",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "American Express Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.amex.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.amex.com/credit-cards",
