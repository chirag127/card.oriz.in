...
export const amexReserveCreditCard: CardData = {
  id: "amex-reserve-credit-card",
  name: "American Express Reserve Credit Card",
  tagline: "Platinum credit card from American Express with rewards on all spends.",
  description: "Platinum credit card from American Express with rewards on all spends. The American Express Reserve Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
