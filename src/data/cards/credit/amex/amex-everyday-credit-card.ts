...
export const amexEverydayCreditCard: CardData = {
  id: "amex-everyday-credit-card",
  name: "American Express Everyday Credit Card",
  tagline: "Platinum credit card from American Express with rewards on all spends.",
  description: "Platinum credit card from American Express with rewards on all spends. The American Express Everyday Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
