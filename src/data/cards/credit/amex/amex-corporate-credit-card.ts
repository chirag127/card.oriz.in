...
export const amexCorporateCreditCard: CardData = {
  id: "amex-corporate-credit-card",
  name: "American Express Corporate Credit Card",
  tagline: "Corporate credit card from American Express with rewards on all spends.",
  description: "Corporate credit card from American Express with rewards on all spends. The American Express Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
