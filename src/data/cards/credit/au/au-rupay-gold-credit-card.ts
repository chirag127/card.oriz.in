...
export const au_rupay_gold_credit_card: CardData = {
  id: "au-rupay-gold-credit-card",
  name: "AU Small Finance Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The AU SFB RuPay Gold Credit Card is a lifetime-free domestic card.",
