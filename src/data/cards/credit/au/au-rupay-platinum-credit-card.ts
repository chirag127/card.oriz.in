...
export const au_rupay_platinum_credit_card: CardData = {
  id: "au-rupay-platinum-credit-card",
  name: "AU Small Finance Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The AU SFB RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
