...
export const auCorporateCreditCard: CardData = {
  id: "au-corporate-credit-card",
  name: "AU Small Finance Bank Corporate Credit Card",
  tagline: "Corporate credit card from AU Small Finance Bank with rewards on all spends.",
  description: "Corporate credit card from AU Small Finance Bank with rewards on all spends. The AU Small Finance Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "AU Small Finance Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "AU Small Finance Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.au.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.au.com/credit-cards",
