...
export const auPremiumCreditCard: CardData = {
  id: "au-premium-credit-card",
  name: "AU Small Finance Bank Premium Credit Card",
  tagline: "Platinum credit card from AU Small Finance Bank with rewards on all spends.",
  description: "Platinum credit card from AU Small Finance Bank with rewards on all spends. The AU Small Finance Bank Premium Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
