...
export const auBusinessCreditCard: CardData = {
  id: "au-business-credit-card",
  name: "AU Small Finance Bank Business Credit Card",
  tagline: "Corporate credit card from AU Small Finance Bank with rewards on all spends.",
  description: "Corporate credit card from AU Small Finance Bank with rewards on all spends. The AU Small Finance Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
