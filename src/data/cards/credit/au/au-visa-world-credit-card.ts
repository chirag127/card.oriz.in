...
export const au_visa_world_credit_card: CardData = {
  id: "au-visa-world-credit-card",
  name: "AU Small Finance Bank Visa World Credit Card",
  tagline: "Premium international card",
  description: "The AU SFB Visa World Credit Card offers premium travel benefits and lounge access.",
