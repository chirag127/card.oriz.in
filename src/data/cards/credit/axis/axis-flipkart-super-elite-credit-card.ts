...
export const axisFlipkartSuperEliteCreditCard: CardData = {
  id: "axis-flipkart-super-elite-credit-card",
  name: "Axis Bank Flipkart Super Elite Credit Card",
  tagline: "Signature credit card from Axis Bank with rewards on all spends.",
  description: "Signature credit card from Axis Bank with rewards on all spends. The Axis Bank Flipkart Super Elite Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
