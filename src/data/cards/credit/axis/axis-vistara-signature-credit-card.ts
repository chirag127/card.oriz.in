...
export const axisVistaraSignatureCreditCard: CardData = {
  id: "axis-vistara-signature-credit-card",
  name: "Axis Bank Vistara Signature Credit Card",
  tagline: "Signature credit card from Axis Bank with rewards on all spends.",
  description: "Signature credit card from Axis Bank with rewards on all spends. The Axis Bank Vistara Signature Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
