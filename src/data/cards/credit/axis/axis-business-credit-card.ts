...
export const axisBusinessCreditCard: CardData = {
  id: "axis-business-credit-card",
  name: "Axis Bank Business Credit Card",
  tagline: "Corporate credit card from Axis Bank with rewards on all spends.",
  description: "Corporate credit card from Axis Bank with rewards on all spends. The Axis Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
