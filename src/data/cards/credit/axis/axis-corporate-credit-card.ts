...
export const axisCorporateCreditCard: CardData = {
  id: "axis-corporate-credit-card",
  name: "Axis Bank Corporate Credit Card",
  tagline: "Corporate credit card from Axis Bank with rewards on all spends.",
  description: "Corporate credit card from Axis Bank with rewards on all spends. The Axis Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Axis Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Axis Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.axis.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.axis.com/credit-cards",
