...
export const axisAtlasCreditCard: CardData = {
  id: "axis-atlas-credit-card",
  name: "Axis Bank Atlas Credit Card",
  tagline: "Platinum credit card from Axis Bank with rewards on all spends.",
  description: "Platinum credit card from Axis Bank with rewards on all spends. The Axis Bank Atlas Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
