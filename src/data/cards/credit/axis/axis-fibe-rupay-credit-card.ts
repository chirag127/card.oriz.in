...
export const axisFibeRupayCreditCard: CardData = {
  id: "axis-fibe-rupay-credit-card",
  name: "Axis Bank Fibe Rupay Credit Card",
  tagline: "Platinum credit card from Axis Bank with rewards on all spends.",
  description: "Platinum credit card from Axis Bank with rewards on all spends. The Axis Bank Fibe Rupay Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "credit",
