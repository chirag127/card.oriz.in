...
export const canaraVisaClassicCreditCard: CardData = {
  id: "canara-visa-classic-credit-card",
  name: "Canara Visa Classic Credit Card",
  tagline: "Lifetime free Visa Classic for everyday transactions",
  description: "The Canara Visa Classic Credit Card is a lifetime-free Visa Classic card offering 1 reward point per ₹100 spent. With no annual fees and basic credit card features, it is an ideal entry-level card for first-time users and those seeking a simple, no-frills credit card from a trusted public sector bank.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "Visa",
  cardType: "credit",
