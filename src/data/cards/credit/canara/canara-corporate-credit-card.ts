...
export const canaraCorporateCreditCard: CardData = {
  id: "canara-corporate-credit-card",
  name: "Canara Bank Corporate Credit Card",
  tagline: "Corporate credit card from Canara Bank with rewards on all spends.",
  description: "Corporate credit card from Canara Bank with rewards on all spends. The Canara Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Canara Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Canara Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.canara.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.canara.com/credit-cards",
