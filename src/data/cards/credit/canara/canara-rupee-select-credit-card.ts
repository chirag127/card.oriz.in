...
export const canaraRupaySelectCreditCard: CardData = {
  id: "canara-rupee-select-credit-card",
  name: "Canara RuPay Select Credit Card",
  tagline: "Lifetime free RuPay Select with lounge access and UPI support",
  description: "The Canara RuPay Select Credit Card is a lifetime-free RuPay Select card offering 2 reward points per ₹100 spent. With complimentary domestic airport lounge access and UPI integration, it provides a well-rounded experience for customers of Canara Bank seeking a reliable everyday credit card.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "RuPay",
  cardType: "credit",
  ...
  bestFor: ["UPI Payments", "Lounge Access", "No Annual Fee"],
