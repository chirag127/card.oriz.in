...
export const canaraGoldRewardsCreditCard: CardData = {
  id: "canara-gold-rewards-credit-card",
  name: "Canara Bank Gold Rewards Credit Card",
  tagline: "Gold credit card from Canara Bank with rewards on all spends.",
  description: "Gold credit card from Canara Bank with rewards on all spends. The Canara Bank Gold Rewards Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "Visa",
  cardType: "credit",
