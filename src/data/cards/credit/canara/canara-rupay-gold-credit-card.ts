...
export const canara_rupay_gold_credit_card: CardData = {
  id: "canara-rupay-gold-credit-card",
  name: "Canara Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Canara Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.canara.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 106 0606",
  applyUrl: "https://www.canarabank.com/credit-card",
