...
export const canara_rupay_platinum_credit_card: CardData = {
  id: "canara-rupay-platinum-credit-card",
  name: "Canara Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Canara Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "RuPay",
  cardType: "credit",
