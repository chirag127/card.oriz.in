...
export const canara_mastercard_world_credit_card: CardData = {
  id: "canara-mastercard-world-credit-card",
  name: "Canara Bank Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The Canara Bank Mastercard World Credit Card offers premium travel benefits.",
  bank: "Canara Bank",
  bankCode: "canara",
  network: "Mastercard",
  cardType: "credit",
