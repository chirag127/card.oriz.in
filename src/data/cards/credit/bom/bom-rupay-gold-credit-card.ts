...
export const bom_rupay_gold_credit_card: CardData = {
  id: "bom-rupay-gold-credit-card",
  name: "Bank of Maharashtra RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The BOM RuPay Gold Credit Card is a lifetime-free domestic card with UPI support and basic rewards.",
