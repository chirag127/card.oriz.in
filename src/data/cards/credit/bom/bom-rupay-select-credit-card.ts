...
export const bomRupaySelectCreditCard: CardData = {
  id: "bom-rupay-select-credit-card",
  name: "Bank of Maharashtra RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Bank of Maharashtra with UPI support.",
  description: "Lifetime free RuPay credit card from Bank of Maharashtra with UPI support. The Bank of Maharashtra RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Bank of Maharashtra Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
