...
export const bom_mastercard_platinum_credit_card: CardData = {
  id: "bom-mastercard-platinum-credit-card",
  name: "Bank of Maharashtra Mastercard Platinum Credit Card",
  tagline: "Premium international card with benefits",
  description: "The BOM Mastercard Platinum Credit Card offers domestic lounge access, accelerated rewards, and international acceptance.",
