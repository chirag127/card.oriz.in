...
export const bomVisaPlatinumCreditCard: CardData = {
  id: "bom-visa-platinum-credit-card",
  name: "Bank of Maharashtra Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Bank of Maharashtra with balanced rewards.",
  description: "Mid-range credit card from Bank of Maharashtra with balanced rewards. The Bank of Maharashtra Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Bank of Maharashtra Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
