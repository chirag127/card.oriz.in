...
export const unionBusinessCreditCard: CardData = {
  id: "union-business-credit-card",
  name: "Union Bank of India Business Credit Card",
  tagline: "Corporate credit card from Union Bank of India with rewards on all spends.",
  description: "Corporate credit card from Union Bank of India with rewards on all spends. The Union Bank of India Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
