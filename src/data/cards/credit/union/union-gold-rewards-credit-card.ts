...
export const unionGoldRewardsCreditCard: CardData = {
  id: "union-gold-rewards-credit-card",
  name: "Union Bank of India Gold Rewards Credit Card",
  tagline: "Gold credit card from Union Bank of India with rewards on all spends.",
  description: "Gold credit card from Union Bank of India with rewards on all spends. The Union Bank of India Gold Rewards Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  milestoneBonuses: [{ description: "Bonus on reaching annual spend milestone", spendRequired: 49900, spendPeriod: "Annually", rewardStr: "Bonus Reward Points", rewardNum: 998 }],
  feeWaivers: [{ description: "Annual fee waived on spending ₹24,950 in the preceding year", annualSpendRequired: 24950, waives: "Annual fee of ₹499" }],
  ...
  value: { highestValue: 9980, averageValue: 4990, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 4401, tenYearNetValue: 44010, totalAnnualCharges: 589, totalAnnualBenefits: 4990, roiPercent: 847 },
