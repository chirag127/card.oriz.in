...
export const unionCorporateCreditCard: CardData = {
  id: "union-corporate-credit-card",
  name: "Union Bank of India Corporate Credit Card",
  tagline: "Corporate credit card from Union Bank of India with rewards on all spends.",
  description: "Corporate credit card from Union Bank of India with rewards on all spends. The Union Bank of India Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Union Bank of India",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Union Bank of India Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.union.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.union.com/credit-cards",
