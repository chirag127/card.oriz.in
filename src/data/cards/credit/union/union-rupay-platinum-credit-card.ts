...
export const unionRupayPlatinumCreditCard: CardData = {
  id: "union-rupay-platinum-credit-card",
  name: "Union RuPay Platinum Credit Card",
  tagline: "Lifetime free RuPay Platinum for everyday transactions",
  description: "The Union RuPay Platinum Credit Card is a lifetime-free RuPay Platinum card offering 1 reward point per ₹100 spent. With no annual fees and basic credit card features, it is an ideal entry-level card for customers of Union Bank of India seeking a simple, no-frills RuPay credit card for everyday use.",
