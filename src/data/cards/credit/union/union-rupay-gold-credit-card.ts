...
export const union_rupay_gold_credit_card: CardData = {
  id: "union-rupay-gold-credit-card",
  name: "Union Bank of India RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Union Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.union.com/credit-cards"], lastVerified: "2026-04-08" },
