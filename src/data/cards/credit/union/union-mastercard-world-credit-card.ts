...
export const union_mastercard_world_credit_card: CardData = {
  id: "union-mastercard-world-credit-card",
  name: "Union Bank of India Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The Union Bank Mastercard World Credit Card offers premium travel benefits.",
