...
export const unionSignatureCreditCard: CardData = {
  id: "union-signature-credit-card",
  name: "Union Signature Credit Card",
  tagline: "Premium Visa Signature with 4X rewards and 8 lounge visits",
  description: "The Union Signature Credit Card is a premium Visa Signature card offering 4 reward points per ₹100 spent. With 8 complimentary domestic lounge visits per year, comprehensive insurance, and competitive rewards, it provides excellent value for professionals and frequent travelers.",
  ...
  eligibility: {
    ...
    notes: [
      "Salaried: Net Monthly Income > ₹60,000",
  ...
  charges: [
    { label: "Joining Fee", amount: 2499, amountWithGst: 2949, note: "Plus GST" },
    { label: "Annual Fee", amount: 2499, amountWithGst: 2949, note: "Plus GST, waived on ₹5L annual spend" },
  ...
  loungeAccess: {
    ...
    programs: ["Dreamfolks"],
    conditions: [
      "8 complimentary domestic lounge visits per year (2 per quarter)",
    ],
  },
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 4 reward points on every ₹100 spent",
      valueStr: "4 RP/₹100",
      valueNum: 1.00,
  ...
  milestoneBonuses: [
    {
      description: "Annual fee waiver on spending ₹5 Lakh in a year",
  ...
  feeWaivers: [
    {
      description: "Annual fee waived on spending ₹5 Lakh in a membership year",
  ...
  value: {
    ...
    annualNetValue: 27051,
    tenYearNetValue: 270510,
  ...
  bestFor: ["Travel", "Rewards", "Lounge Access"],
