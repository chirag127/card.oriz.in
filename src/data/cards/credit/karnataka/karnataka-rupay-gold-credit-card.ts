...
export const karnataka_rupay_gold_credit_card: CardData = {
  id: "karnataka-rupay-gold-credit-card",
  name: "Karnataka Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Karnataka Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.karnataka.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 425 8668",
