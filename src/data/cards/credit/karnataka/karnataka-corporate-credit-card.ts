...
export const karnatakaCorporateCreditCard: CardData = {
  id: "karnataka-corporate-credit-card",
  name: "Karnataka Bank Corporate Credit Card",
  tagline: "Corporate credit card from Karnataka Bank with rewards on all spends.",
  description: "Corporate credit card from Karnataka Bank with rewards on all spends. The Karnataka Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Karnataka Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Karnataka Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.karnataka.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.karnataka.com/credit-cards",
