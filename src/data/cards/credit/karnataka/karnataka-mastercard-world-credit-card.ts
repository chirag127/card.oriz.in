...
export const karnataka_mastercard_world_credit_card: CardData = {
  id: "karnataka-mastercard-world-credit-card",
  name: "Karnataka Bank Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The Karnataka Bank Mastercard World Credit Card offers premium travel benefits.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Mastercard",
  cardType: "credit",
