...
export const karnatakaBusinessCreditCard: CardData = {
  id: "karnataka-business-credit-card",
  name: "Karnataka Bank Business Credit Card",
  tagline: "Corporate credit card from Karnataka Bank with rewards on all spends.",
  description: "Corporate credit card from Karnataka Bank with rewards on all spends. The Karnataka Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Visa",
  cardType: "credit",
