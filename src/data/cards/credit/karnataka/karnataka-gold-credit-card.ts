...
export const karnatakaGoldCreditCard: CardData = {
  id: "karnataka-gold-credit-card",
  name: "Karnataka Bank Gold Credit Card",
  tagline: "Gold credit card from Karnataka Bank with rewards on all spends.",
  description: "Gold credit card from Karnataka Bank with rewards on all spends. The Karnataka Bank Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Visa",
  cardType: "credit",
