...
export const karnataka_rupay_platinum_credit_card: CardData = {
  id: "karnataka-rupay-platinum-credit-card",
  name: "Karnataka Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Karnataka Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "RuPay",
  cardType: "credit",
