...
export const karnatakaVisaSignatureCreditCard: CardData = {
  ...
  name: "Karnataka Bank Visa Signature Credit Card",
  tagline: "Premium card with enhanced rewards and lounge access",
  description: "The Karnataka Bank Visa Signature Credit Card is a premium offering with enhanced rewards, domestic lounge access, and comprehensive travel insurance for frequent travelers.",
  bank: "Karnataka Bank",
  bankCode: "karnataka",
  network: "Visa",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.karnatakabank.com/credit-cards"], lastVerified: "2026-04-08" },
