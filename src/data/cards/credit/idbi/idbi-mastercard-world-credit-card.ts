...
export const idbi_mastercard_world_credit_card: CardData = {
  id: "idbi-mastercard-world-credit-card",
  name: "IDBI Bank Mastercard World Credit Card",
  tagline: "Premium international card with enhanced travel benefits",
  description: "The IDBI Bank Mastercard World Credit Card is a premium international card offering enhanced travel benefits, complimentary lounge access, and accelerated rewards on international spends. It includes comprehensive travel insurance and exclusive Mastercard World privileges.",
  bank: "IDBI Bank",
  bankCode: "idbi",
  network: "Mastercard",
  cardType: "credit",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 5 reward points per Rs 100 on international, travel",
  ...
  rewardProgram: {
    ...
    earnRate: "5 RP per Rs 100 on international spends",
    pointsPer100: 5,
    pointValue: 0.3,
    effectiveCashbackPercent: 1.5,
    pointsExpiry: "2 years from date of accrual",
    bonusCategories: [{"category":"International","multiplier":5,"description":"5 RP per Rs 100"},{"category":"Travel","multiplier":4,"description":"4 RP per Rs 100"}],
  ...
  welcomeBonus: {
    available: true,
    description: "3,000 bonus reward points on joining fee payment",
    valueStr: "3,000 RP",
    valueNum: 3000,
    conditions: ["Spend Rs 20,000 within 60 days"],
  },
  ...
  value: {
    ...
    annualNetValue: 31460,
    tenYearNetValue: 314600,
