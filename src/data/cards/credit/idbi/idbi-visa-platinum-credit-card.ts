...
export const idbi_visa_platinum_credit_card: CardData = {
  id: "idbi-visa-platinum-credit-card",
  name: "IDBI Bank Visa Platinum Credit Card",
  tagline: "Balanced rewards and everyday value with comprehensive coverage",
  description: "The IDBI Bank Visa Platinum Credit Card offers a balanced mix of rewards, benefits, and convenience for everyday spends. With accelerated reward points on select categories, fuel surcharge waiver, and comprehensive insurance coverage, it is ideal for regular credit card users seeking value.",
  bank: "IDBI Bank",
  bankCode: "idbi",
  network: "Visa",
  cardType: "credit",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 3 reward points per Rs 100 on shopping, dining",
    ...
    },
    {
      ...
      description: "Annual fee waived on spending Rs 2.5 Lakh annually",
      valueStr: "Fee waiver",
      valueNum: 1000,
      frequencyStr: "Annually",
      frequencyPerYear: 1,
  ...
  rewardProgram: {
    ...
    earnRate: "3 RP per Rs 100 on selected categories",
    pointsPer100: 3,
    pointValue: 0.25,
    effectiveCashbackPercent: 0.75,
    pointsExpiry: "2 years from date of accrual",
    bonusCategories: [{"category":"Shopping","multiplier":3,"description":"3 RP per Rs 100"},{"category":"Dining","multiplier":3,"description":"3 RP per Rs 100"}],
  ...
  welcomeBonus: {
    ...
    valueStr: "1,000 RP",
    valueNum: 1000,
    conditions: ["First transaction within 30 days"],
  },

  milestoneBonuses: [
    {
      description: "Earn 2,000 bonus points on annual spend of Rs 2 Lakh",
  ...
  feeWaivers: [
    {
      description: "Annual fee waived on annual spend of Rs 2.5 Lakh",
