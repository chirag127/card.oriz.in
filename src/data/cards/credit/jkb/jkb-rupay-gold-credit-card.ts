...
export const jkb_rupay_gold_credit_card: CardData = {
  id: "jkb-rupay-gold-credit-card",
  name: "Jammu & Kashmir Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The J&K Bank RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
