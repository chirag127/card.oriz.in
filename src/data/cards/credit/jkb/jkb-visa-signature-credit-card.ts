...
export const jkbVisaSignatureCreditCard: CardData = {
  id: "jkb-visa-signature-credit-card",
  name: "Jammu & Kashmir Bank Visa Signature Credit Card",
  tagline: "Premium credit card from Jammu & Kashmir Bank with travel and rewards benefits.",
  description: "Premium credit card from Jammu & Kashmir Bank with travel and rewards benefits. The Jammu & Kashmir Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Jammu & Kashmir Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Jammu & Kashmir Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.jkb.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.jkb.com/credit-cards",
