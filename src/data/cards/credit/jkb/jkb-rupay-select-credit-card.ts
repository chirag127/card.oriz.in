...
export const jkbRupaySelectCreditCard: CardData = {
  id: "jkb-rupay-select-credit-card",
  name: "Jammu & Kashmir Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Jammu & Kashmir Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Jammu & Kashmir Bank with UPI support. The Jammu & Kashmir Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Jammu & Kashmir Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
