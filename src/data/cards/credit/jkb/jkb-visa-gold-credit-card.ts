...
export const jkb_visa_gold_credit_card: CardData = {
  id: "jkb-visa-gold-credit-card",
  name: "Jammu & Kashmir Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The J&K Bank Visa Gold Credit Card offers basic international credit card features with rewards and fuel surcharge waiver.",
