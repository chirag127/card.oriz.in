...
export const jkbVisaPlatinumCreditCard: CardData = {
  id: "jkb-visa-platinum-credit-card",
  name: "Jammu & Kashmir Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Jammu & Kashmir Bank with balanced rewards.",
  description: "Mid-range credit card from Jammu & Kashmir Bank with balanced rewards. The Jammu & Kashmir Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Jammu & Kashmir Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
