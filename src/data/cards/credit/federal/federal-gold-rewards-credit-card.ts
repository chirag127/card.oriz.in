...
export const federalGoldRewardsCreditCard: CardData = {
  id: "federal-gold-rewards-credit-card",
  name: "Federal Bank Gold Rewards Credit Card",
  tagline: "Gold credit card from Federal Bank with rewards on all spends.",
  description: "Gold credit card from Federal Bank with rewards on all spends. The Federal Bank Gold Rewards Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "credit",
