...
export const federal_mastercard_gold_credit_card: CardData = {
  id: "federal-mastercard-gold-credit-card",
  name: "Federal Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The Federal Bank Mastercard Gold Credit Card offers basic international features.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Mastercard",
  cardType: "credit",
