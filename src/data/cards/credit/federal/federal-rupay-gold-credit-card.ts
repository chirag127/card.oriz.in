...
export const federal_rupay_gold_credit_card: CardData = {
  id: "federal-rupay-gold-credit-card",
  name: "Federal Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Federal Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.federal.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 425 1199",
