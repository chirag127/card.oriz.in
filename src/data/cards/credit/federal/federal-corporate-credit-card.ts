...
export const federalCorporateCreditCard: CardData = {
  id: "federal-corporate-credit-card",
  name: "Federal Bank Corporate Credit Card",
  tagline: "Corporate credit card from Federal Bank with rewards on all spends.",
  description: "Corporate credit card from Federal Bank with rewards on all spends. The Federal Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Federal Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Federal Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.federal.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.federal.com/credit-cards",
