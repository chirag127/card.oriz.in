...
export const federalBusinessCreditCard: CardData = {
  id: "federal-business-credit-card",
  name: "Federal Bank Business Credit Card",
  tagline: "Corporate credit card from Federal Bank with rewards on all spends.",
  description: "Corporate credit card from Federal Bank with rewards on all spends. The Federal Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "credit",
