...
export const federal_rupay_platinum_credit_card: CardData = {
  id: "federal-rupay-platinum-credit-card",
  name: "Federal Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Federal Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "RuPay",
  cardType: "credit",
