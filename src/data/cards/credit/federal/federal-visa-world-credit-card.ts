...
export const federal_visa_world_credit_card: CardData = {
  id: "federal-visa-world-credit-card",
  name: "Federal Bank Visa World Credit Card",
  tagline: "Premium international card",
  description: "The Federal Bank Visa World Credit Card offers premium travel benefits and lounge access.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "credit",
