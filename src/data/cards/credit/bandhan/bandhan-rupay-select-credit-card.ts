...
export const bandhanRupaySelectCreditCard: CardData = {
  id: "bandhan-rupay-select-credit-card",
  name: "Bandhan Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Bandhan Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Bandhan Bank with UPI support. The Bandhan Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  bank: "Bandhan Bank",
  bankCode: "bandhan",
  network: "RuPay",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "Bandhan Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
