...
export const bandhan_rupay_gold_credit_card: CardData = {
  id: "bandhan-rupay-gold-credit-card",
  name: "Bandhan Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Bandhan Bank RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
  bank: "Bandhan Bank",
  bankCode: "bandhan",
  network: "RuPay",
  cardType: "credit",
