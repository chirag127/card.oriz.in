...
export const bandhanVisaSignatureCreditCard: CardData = {
  id: "bandhan-visa-signature-credit-card",
  name: "Bandhan Bank Visa Signature Credit Card",
  tagline: "Premium credit card from Bandhan Bank with travel and rewards benefits.",
  description: "Premium credit card from Bandhan Bank with travel and rewards benefits. The Bandhan Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  bank: "Bandhan Bank",
  bankCode: "bandhan",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Bandhan Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Bandhan Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.bandhan.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.bandhan.com/credit-cards",
