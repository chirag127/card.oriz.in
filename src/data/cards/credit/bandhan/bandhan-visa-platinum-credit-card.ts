...
export const bandhanVisaPlatinumCreditCard: CardData = {
  id: "bandhan-visa-platinum-credit-card",
  name: "Bandhan Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Bandhan Bank with balanced rewards.",
  description: "Mid-range credit card from Bandhan Bank with balanced rewards. The Bandhan Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Bandhan Bank",
  bankCode: "bandhan",
  network: "Visa",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "Bandhan Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
