...
export const saraswat_rupay_gold_credit_card: CardData = {
  id: "saraswat-rupay-gold-credit-card",
  name: "Saraswat Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Saraswat Bank RuPay Gold Credit Card is a lifetime-free domestic credit card with UPI support, basic rewards, and fuel surcharge waiver for everyday transactions.",
  bank: "Saraswat Bank",
  bankCode: "saraswat",
  network: "RuPay",
  cardType: "credit",
