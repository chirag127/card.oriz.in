...
export const saraswat_visa_platinum_credit_card: CardData = {
  id: "saraswat-visa-platinum-credit-card",
  name: "Saraswat Bank Visa Platinum Credit Card",
  tagline: "Premium rewards with domestic lounge access",
  description: "The Saraswat Bank Visa Platinum Credit Card offers premium rewards, domestic lounge access, and enhanced insurance coverage for regular credit card users who travel occasionally.",
  bank: "Saraswat Bank",
  bankCode: "saraswat",
  network: "Visa",
  cardType: "credit",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 3 reward points per Rs 100 on shopping, travel",
  ...
  rewardProgram: {
    ...
    bonusCategories: [{"category":"Shopping","multiplier":3,"description":"3 RP per Rs 100"},{"category":"Travel","multiplier":3,"description":"3 RP per Rs 100"}],
    redemptionOptions: ["Statement credit","Gift vouchers","Products"],
  ...
  welcomeBonus: {
    ...
    valueStr: "1,500 RP",
    valueNum: 1500,
    conditions: ["Spend Rs 10,000 within 30 days"],
  },

  milestoneBonuses: [
    {
      description: "Earn 2,500 bonus points on annual spend of Rs 3 Lakh",
      spendRequired: 300000,
      spendPeriod: "Annually",
      rewardStr: "2,500 bonus points",
      rewardNum: 2500,
    }
  ],
