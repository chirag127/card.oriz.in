...
export const saraswat_mastercard_platinum_credit_card: CardData = {
  id: "saraswat-mastercard-platinum-credit-card",
  name: "Saraswat Bank Mastercard Platinum Credit Card",
  tagline: "International card with lounge access and rewards",
  description: "The Saraswat Bank Mastercard Platinum Credit Card offers international acceptance, domestic lounge access, and accelerated rewards for frequent travelers and shoppers.",
  bank: "Saraswat Bank",
  bankCode: "saraswat",
  network: "Mastercard",
  cardType: "credit",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 3 reward points per Rs 100 on travel, shopping",
  ...
  rewardProgram: {
    ...
    earnRate: "3 RP per Rs 100 on travel and shopping",
    pointsPer100: 3,
    pointValue: 0.25,
    effectiveCashbackPercent: 0.75,
    pointsExpiry: "2 years from date of accrual",
    bonusCategories: [{"category":"Travel","multiplier":3,"description":"3 RP per Rs 100"},{"category":"Shopping","multiplier":3,"description":"3 RP per Rs 100"}],
    redemptionOptions: ["Statement credit","Gift vouchers","Air miles"],
  ...
  milestoneBonuses: [
    {
      description: "Earn 2,000 bonus points on annual spend of Rs 2.5 Lakh",
  ...
  feeWaivers: [
    {
      ...
      waives: "Annual fee of Rs 1,500 + GST",
    }
  ],
  ...
  value: {
    ...
    annualNetValue: 12230,
    tenYearNetValue: 122300,
    totalAnnualCharges: 1770,
    totalAnnualBenefits: 14000,
    roiPercent: 791,
  },
