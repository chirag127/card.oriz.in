...
export const sbiDelhiMetroCreditCard: CardData = {
  ...
  name: "SBI Card Delhi Metro Credit Card",
  tagline: "Platinum credit card from SBI Card with rewards on all spends.",
  description: "Platinum credit card from SBI Card with rewards on all spends. The SBI Card Delhi Metro Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
