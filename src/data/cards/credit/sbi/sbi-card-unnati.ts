...
export const sbiCardUnnati: CardData = {
  id: "sbi-card-unnati",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Standard reward points on all spends",
      valueStr: "Standard reward points",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Standard reward points",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "Standard reward points",
  },
