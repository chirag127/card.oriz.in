...
export const sbiCardPulse: CardData = {
  id: "sbi-card-pulse",
  name: "SBI Card PULSE",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Accelerated on lifestyle/entertainment on all spends",
      valueStr: "Accelerated on lifestyle/entertainment",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Accelerated on lifestyle/entertainment",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "Accelerated on lifestyle/entertainment",
  },
