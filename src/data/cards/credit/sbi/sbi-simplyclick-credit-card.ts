...
export const sbiSimplyclickCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#2a3a5e and #5F7EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 10X RP on Amazon/partners, 5X online on all spends",
      valueStr: "10X RP on Amazon/partners, 5X online",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "10X RP on Amazon/partners, 5X online",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "10X RP on Amazon/partners, 5X online",
  },

  welcomeBonus: {
    available: true,
    description: "Amazon gift card on activation",
    valueStr: "Amazon gift card on activation",
    valueNum: 0,
    conditions: [],
  },
