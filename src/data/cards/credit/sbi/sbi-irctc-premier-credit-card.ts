...
export const sbiIrctcPremierCreditCard: CardData = {
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 3 RP per ₹125 dining/utility on all spends",
      valueStr: "3 RP per ₹125 dining/utility",
      valueNum: 0,
    ...
    },
    {
      ...
      description: "Complimentary domestic lounge access: Railway lounges",
      valueStr: "Railway lounges",
      valueNum: 1000,
  ...
  rewardProgram: {
    ...
    earnRate: "3 RP per ₹125 dining/utility",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "3 RP per ₹125 dining/utility",
  },

  welcomeBonus: {
    available: true,
    description: "1,500 RP worth ₹1,500",
    valueStr: "1,500 RP worth ₹1,500",
    valueNum: 750,
    conditions: [],
  },
