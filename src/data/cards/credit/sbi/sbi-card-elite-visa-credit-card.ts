...
export const sbiCardEliteVisaCreditCard: CardData = {
  id: "sbi-card-elite-visa-credit-card",
  name: "SBI Card Card Elite Visa Credit Card",
  tagline: "Signature credit card from SBI Card with rewards on all spends.",
  description: "Signature credit card from SBI Card with rewards on all spends. The SBI Card Card Elite Visa Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
