...
export const sbiBpclOctaneCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#4a1a1a and #BF4F4F gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 25X RP on BPCL fuel, 10X dining/stores on all spends",
      valueStr: "25X RP on BPCL fuel, 10X dining/stores",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "25X RP on BPCL fuel, 10X dining/stores",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "25X RP on BPCL fuel, 10X dining/stores",
  },

  welcomeBonus: {
    available: true,
    description: "6,000 bonus reward points",
    valueStr: "6,000 bonus reward points",
    valueNum: 750,
    conditions: [],
  },
