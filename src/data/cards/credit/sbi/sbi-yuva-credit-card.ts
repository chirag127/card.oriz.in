...
export const sbiYuvaCreditCard: CardData = {
  id: "sbi-yuva-credit-card",
  name: "SBI Card Yuva Credit Card",
  tagline: "Platinum credit card from SBI Card with rewards on all spends.",
  description: "Platinum credit card from SBI Card with rewards on all spends. The SBI Card Yuva Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
