...
export const sbiCorporateCreditCard: CardData = {
  id: "sbi-corporate-credit-card",
  name: "SBI Card Corporate Credit Card",
  tagline: "Corporate credit card from SBI Card with rewards on all spends.",
  description: "Corporate credit card from SBI Card with rewards on all spends. The SBI Card Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "SBI Card",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "SBI Card Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.sbi.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.sbi.com/credit-cards",
