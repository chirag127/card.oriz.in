...
export const sbiUnnatiCreditCard: CardData = {
  id: "sbi-unnati-credit-card",
  name: "SBI Card Unnati Credit Card",
  tagline: "Platinum credit card from SBI Card with rewards on all spends.",
  description: "Platinum credit card from SBI Card with rewards on all spends. The SBI Card Unnati Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
