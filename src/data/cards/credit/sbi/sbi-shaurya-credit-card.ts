...
export const sbiShauryaCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#2a3a1a and #5F8E4F gradient",
  ...
  insurance: {
    accidentalDeathCover: 200000,
    permanentDisabilityCover: 160000,
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5 RP per ₹100 on movies/dining/grocery on all spends",
      valueStr: "5 RP per ₹100 on movies/dining/grocery",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5 RP per ₹100 on movies/dining/grocery",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "5 RP per ₹100 on movies/dining/grocery",
  },

  welcomeBonus: {
    available: true,
    description: "1,000 welcome reward points",
    valueStr: "1,000 welcome reward points",
    valueNum: 0,
    conditions: [],
  },
  ...
  feeWaivers: [
    { description: "Annual fee waived on spending ₹12,500 in preceding year", annualSpendRequired: 12500, waives: "Annual fee of ₹250" }
  ],
