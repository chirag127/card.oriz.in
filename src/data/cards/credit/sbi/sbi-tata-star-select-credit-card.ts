...
export const sbiTataStarSelectCreditCard: CardData = {
  id: "sbi-tata-star-select-credit-card",
  name: "SBI Card Tata Star Select Credit Card",
  tagline: "Platinum credit card from SBI Card with rewards on all spends.",
  description: "Platinum credit card from SBI Card with rewards on all spends. The SBI Card Tata Star Select Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "credit",
