...
export const sbiRelianceCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#3a2a1a and #9F7E5F gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5 RP per ₹100 at Reliance on all spends",
      valueStr: "5 RP per ₹100 at Reliance",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5 RP per ₹100 at Reliance",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "5 RP per ₹100 at Reliance",
  },

  welcomeBonus: {
    available: true,
    description: "Up to ₹3,700 in vouchers",
    valueStr: "Up to ₹3,700 in vouchers",
    valueNum: 0,
    conditions: [],
  },
