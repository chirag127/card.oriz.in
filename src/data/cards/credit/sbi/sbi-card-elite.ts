...
export const sbiCardElite: CardData = {
  id: "sbi-card-elite",
  name: "SBI Card ELITE",
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#1a1a3e and #4F5EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5 RP per ₹100 on dining/entertainment/grocery on all spends",
      valueStr: "5 RP per ₹100 on dining/entertainment/grocery",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5 RP per ₹100 on dining/entertainment/grocery",
    pointsPer100: 4,
    pointValue: 0.25,
    ...
    rewardRateStr: "5 RP per ₹100 on dining/entertainment/grocery",
  },

  welcomeBonus: {
    available: true,
    description: "Welcome voucher worth ₹5,000",
    valueStr: "Welcome voucher worth ₹5,000",
    valueNum: 2500,
    conditions: [],
  },
