...
export const indusindClubVisaCreditCard: CardData = {
  id: "indusind-club-visa-credit-card",
  name: "IndusInd Bank Club Visa Credit Card",
  tagline: "Platinum credit card from IndusInd Bank with rewards on all spends.",
  description: "Platinum credit card from IndusInd Bank with rewards on all spends. The IndusInd Bank Club Visa Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "IndusInd Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "IndusInd Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.indusind.com"], lastVerified: "2026-03-27" },
