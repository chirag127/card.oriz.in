...
export const indusind_rupay_platinum_credit_card: CardData = {
  id: "indusind-rupay-platinum-credit-card",
  name: "IndusInd Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The IndusInd Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "RuPay",
  cardType: "credit",
