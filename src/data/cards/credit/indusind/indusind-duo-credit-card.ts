...
export const indusindDuoCreditCard: CardData = {
  id: "indusind-duo-credit-card",
  name: "IndusInd Bank Duo Credit Card",
  tagline: "Platinum credit card from IndusInd Bank with rewards on all spends.",
  description: "Platinum credit card from IndusInd Bank with rewards on all spends. The IndusInd Bank Duo Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "Visa",
  cardType: "credit",
