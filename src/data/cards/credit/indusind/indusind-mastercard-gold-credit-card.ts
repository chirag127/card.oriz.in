...
export const indusind_mastercard_gold_credit_card: CardData = {
  id: "indusind-mastercard-gold-credit-card",
  name: "IndusInd Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The IndusInd Bank Mastercard Gold Credit Card offers basic international features.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "Mastercard",
  cardType: "credit",
