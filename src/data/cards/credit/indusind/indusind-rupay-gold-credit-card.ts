...
export const indusind_rupay_gold_credit_card: CardData = {
  id: "indusind-rupay-gold-credit-card",
  name: "IndusInd Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The IndusInd Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.indusind.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1860 267 7777",
  applyUrl: "https://www.indusind.com/credit-cards",
