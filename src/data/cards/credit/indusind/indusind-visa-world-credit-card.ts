...
export const indusind_visa_world_credit_card: CardData = {
  id: "indusind-visa-world-credit-card",
  name: "IndusInd Bank Visa World Credit Card",
  tagline: "Premium international card",
  description: "The IndusInd Bank Visa World Credit Card offers premium travel benefits and lounge access.",
  bank: "IndusInd Bank",
  bankCode: "indusind",
  network: "Visa",
  cardType: "credit",
