...
export const esaf_rupay_gold_credit_card: CardData = {
  id: "esaf-rupay-gold-credit-card",
  name: "ESAF Small Finance Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The ESAF SFB RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
