...
export const esafVisaPlatinumCreditCard: CardData = {
  id: "esaf-visa-platinum-credit-card",
  name: "ESAF Small Finance Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from ESAF Small Finance Bank with balanced rewards.",
  description: "Mid-range credit card from ESAF Small Finance Bank with balanced rewards. The ESAF Small Finance Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "ESAF Small Finance Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
