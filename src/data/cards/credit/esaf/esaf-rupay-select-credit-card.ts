...
export const esafRupaySelectCreditCard: CardData = {
  id: "esaf-rupay-select-credit-card",
  name: "ESAF Small Finance Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from ESAF Small Finance Bank with UPI support.",
  description: "Lifetime free RuPay credit card from ESAF Small Finance Bank with UPI support. The ESAF Small Finance Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "ESAF Small Finance Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
