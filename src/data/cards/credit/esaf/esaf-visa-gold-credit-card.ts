...
export const esaf_visa_gold_credit_card: CardData = {
  id: "esaf-visa-gold-credit-card",
  name: "ESAF Small Finance Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The ESAF SFB Visa Gold Credit Card is an entry-level international card with basic rewards.",
