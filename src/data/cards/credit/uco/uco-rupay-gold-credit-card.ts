...
export const uco_rupay_gold_credit_card: CardData = {
  id: "uco-rupay-gold-credit-card",
  name: "UCO Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI support",
  description: "The UCO Bank RuPay Gold Credit Card is a lifetime-free domestic credit card with UPI support, basic rewards, and fuel surcharge waiver.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "RuPay",
  cardType: "credit",
