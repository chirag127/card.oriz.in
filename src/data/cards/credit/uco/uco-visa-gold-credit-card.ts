...
export const uco_visa_gold_credit_card: CardData = {
  id: "uco-visa-gold-credit-card",
  name: "UCO Bank Visa Gold Credit Card",
  tagline: "Entry-level international card with basic rewards",
  description: "The UCO Bank Visa Gold Credit Card is an entry-level international credit card with basic rewards, fuel surcharge waiver, and travel insurance coverage.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "Visa",
  cardType: "credit",
