...
export const uco_mastercard_platinum_credit_card: CardData = {
  id: "uco-mastercard-platinum-credit-card",
  name: "UCO Bank Mastercard Platinum Credit Card",
  tagline: "Premium card with lounge access and rewards",
  description: "The UCO Bank Mastercard Platinum Credit Card offers domestic lounge access, accelerated rewards, and comprehensive insurance coverage.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "Mastercard",
  cardType: "credit",
  ...
  customerCareNumber: "1800 103 8268",
