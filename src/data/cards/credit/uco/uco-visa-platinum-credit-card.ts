...
export const ucoVisaPlatinumCreditCard: CardData = {
  id: "uco-visa-platinum-credit-card",
  name: "UCO Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from UCO Bank with balanced rewards.",
  description: "Mid-range credit card from UCO Bank with balanced rewards. The UCO Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "Visa",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "UCO Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
