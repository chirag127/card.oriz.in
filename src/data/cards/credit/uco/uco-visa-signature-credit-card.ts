...
export const ucoVisaSignatureCreditCard: CardData = {
  id: "uco-visa-signature-credit-card",
  name: "UCO Bank Visa Signature Credit Card",
  tagline: "Premium credit card from UCO Bank with travel and rewards benefits.",
  description: "Premium credit card from UCO Bank with travel and rewards benefits. The UCO Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "UCO Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "UCO Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.uco.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.uco.com/credit-cards",
