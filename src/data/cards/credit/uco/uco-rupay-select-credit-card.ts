...
export const ucoRupaySelectCreditCard: CardData = {
  id: "uco-rupay-select-credit-card",
  name: "UCO Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from UCO Bank with UPI support.",
  description: "Lifetime free RuPay credit card from UCO Bank with UPI support. The UCO Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  bank: "UCO Bank",
  bankCode: "uco",
  network: "RuPay",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "UCO Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
