...
export const bob_rupay_platinum_credit_card: CardData = {
  id: "bob-rupay-platinum-credit-card",
  name: "Bank of Baroda RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The BOB RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "RuPay",
  cardType: "credit",
