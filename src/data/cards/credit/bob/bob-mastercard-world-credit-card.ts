...
export const bob_mastercard_world_credit_card: CardData = {
  id: "bob-mastercard-world-credit-card",
  name: "Bank of Baroda Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The BOB Mastercard World Credit Card offers premium travel benefits and lounge access.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "Mastercard",
  cardType: "credit",
