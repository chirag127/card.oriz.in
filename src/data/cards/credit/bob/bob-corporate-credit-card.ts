...
export const bobCorporateCreditCard: CardData = {
  id: "bob-corporate-credit-card",
  name: "Bank of Baroda Corporate Credit Card",
  tagline: "Corporate credit card from Bank of Baroda with rewards on all spends.",
  description: "Corporate credit card from Bank of Baroda with rewards on all spends. The Bank of Baroda Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Bank of Baroda",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Bank of Baroda Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.bob.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.bob.com/credit-cards",
