...
export const bobBusinessCreditCard: CardData = {
  id: "bob-business-credit-card",
  name: "Bank of Baroda Business Credit Card",
  tagline: "Corporate credit card from Bank of Baroda with rewards on all spends.",
  description: "Corporate credit card from Bank of Baroda with rewards on all spends. The Bank of Baroda Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "Visa",
  cardType: "credit",
