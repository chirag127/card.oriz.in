...
export const bobTrionCreditCard: CardData = {
  id: "bob-trion-credit-card",
  name: "Bank of Baroda Trion Credit Card",
  tagline: "Platinum credit card from Bank of Baroda with rewards on all spends.",
  description: "Platinum credit card from Bank of Baroda with rewards on all spends. The Bank of Baroda Trion Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "Visa",
  cardType: "credit",
