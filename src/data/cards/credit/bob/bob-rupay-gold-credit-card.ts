...
export const bob_rupay_gold_credit_card: CardData = {
  id: "bob-rupay-gold-credit-card",
  name: "Bank of Baroda RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The BOB RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "Bank of Baroda",
  bankCode: "bob",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.bob.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 258 4444",
  applyUrl: "https://www.bankofbaroda.in/credit-card",
