...
export const tmbVisaPlatinumCreditCard: CardData = {
  id: "tmb-visa-platinum-credit-card",
  name: "Tamilnad Mercantile Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Tamilnad Mercantile Bank with balanced rewards.",
  description: "Mid-range credit card from Tamilnad Mercantile Bank with balanced rewards. The Tamilnad Mercantile Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  transactionCharges: {
    ...
    latePaymentFee: 1000, overLimitFee: 500,
  ...
  rewardProgram: {
    name: "Tamilnad Mercantile Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  welcomeBonus: { available: true, description: "Bonus reward points on card activation", valueStr: "Bonus Points", valueNum: 500, conditions: [] },
  milestoneBonuses: [{ description: "Bonus on reaching annual spend milestone", spendRequired: 99900, spendPeriod: "Annually", rewardStr: "Bonus Reward Points", rewardNum: 1998 }],
  feeWaivers: [{ description: "Annual fee waived on spending ₹49,950 in the preceding year", annualSpendRequired: 49950, waives: "Annual fee of ₹999" }],
  ...
  value: { highestValue: 19980, averageValue: 9990, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 8811, tenYearNetValue: 88110, totalAnnualCharges: 1179, totalAnnualBenefits: 9990, roiPercent: 847 },
