...
export const tmb_visa_gold_credit_card: CardData = {
  id: "tmb-visa-gold-credit-card",
  name: "Tamilnad Mercantile Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The TMB Visa Gold Credit Card is an entry-level international card with basic rewards.",
