...
export const tmb_rupay_gold_credit_card: CardData = {
  id: "tmb-rupay-gold-credit-card",
  name: "Tamilnad Mercantile Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The TMB RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
