...
export const tmbRupaySelectCreditCard: CardData = {
  id: "tmb-rupay-select-credit-card",
  name: "Tamilnad Mercantile Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Tamilnad Mercantile Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Tamilnad Mercantile Bank with UPI support. The Tamilnad Mercantile Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  charges: [
    { label: "Joining Fee", amount: 0, amountWithGst: 0, note: "Excluding GST" },
    { label: "Annual Fee", amount: 0, amountWithGst: 0, note: "Excluding GST" },
  ...
  benefits: [
    {
      category: "rewards", title: "Reward Points", description: "1 RP per ₹100",
      valueStr: "1 RP per ₹100", valueNum: 0, frequencyStr: "Every transaction", frequencyPerYear: 0, annualValue: 0,
  ...
  rewardProgram: {
    name: "Tamilnad Mercantile Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  milestoneBonuses: [{ description: "Bonus on reaching annual spend milestone", spendRequired: 0, spendPeriod: "Annually", rewardStr: "Bonus Reward Points", rewardNum: 0 }],
  feeWaivers: [{ description: "Annual fee waived on spending ₹0 in the preceding year", annualSpendRequired: 0, waives: "Annual fee of ₹0" }],
  ...
  value: { highestValue: 0, averageValue: 0, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 0, tenYearNetValue: 0, totalAnnualCharges: 0, totalAnnualBenefits: 0, roiPercent: 0 },
  ...
  category: "standard",
  internationalUsable: true, bestFor: ["UPI","Cashback"],
