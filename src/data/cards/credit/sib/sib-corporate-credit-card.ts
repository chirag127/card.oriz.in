...
export const sibCorporateCreditCard: CardData = {
  id: "sib-corporate-credit-card",
  name: "South Indian Bank Corporate Credit Card",
  tagline: "Corporate credit card from South Indian Bank with rewards on all spends.",
  description: "Corporate credit card from South Indian Bank with rewards on all spends. The South Indian Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "South Indian Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "South Indian Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.sib.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.sib.com/credit-cards",
