...
export const sib_rupay_platinum_credit_card: CardData = {
  id: "sib-rupay-platinum-credit-card",
  name: "South Indian Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The SIB RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
