...
export const sib_rupay_gold_credit_card: CardData = {
  id: "sib-rupay-gold-credit-card",
  name: "South Indian Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The SIB RuPay Gold Credit Card is a lifetime-free domestic card.",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.sib.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 123 123",
