...
export const sibGoldCreditCard: CardData = {
  id: "sib-gold-credit-card",
  name: "South Indian Bank Gold Credit Card",
  tagline: "Gold credit card from South Indian Bank with rewards on all spends.",
  description: "Gold credit card from South Indian Bank with rewards on all spends. The South Indian Bank Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
