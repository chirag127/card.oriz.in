...
export const sibVisaSignatureCreditCard: CardData = {
  id: "sib-visa-signature-credit-card",
  name: "SIB Visa Signature Credit Card",
  tagline: "Premium Visa Signature with 4X rewards and 6 lounge visits",
  description: "The SIB Visa Signature Credit Card is a premium Visa Signature card from South Indian Bank offering 4 reward points per ₹100 spent. With 6 complimentary domestic lounge visits per year and comprehensive benefits, it provides excellent value for professionals seeking a well-rounded premium credit card.",
  ...
  bin: "",
  material: "Hybrid",
  colorScheme: "Dark blue and gold",
  ...
  benefits: [
    {
      ...
      frequencyPerYear: 6,
      annualValue: 12000,
      conditions: ["6 complimentary visits at domestic lounges"],
      isSellable: false,
      sellValue: 0,
      isActive: true,
