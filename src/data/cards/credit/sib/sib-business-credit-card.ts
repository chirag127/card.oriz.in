...
export const sibBusinessCreditCard: CardData = {
  id: "sib-business-credit-card",
  name: "South Indian Bank Business Credit Card",
  tagline: "Corporate credit card from South Indian Bank with rewards on all spends.",
  description: "Corporate credit card from South Indian Bank with rewards on all spends. The South Indian Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
