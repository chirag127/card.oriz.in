...
export const sib_mastercard_world_credit_card: CardData = {
  id: "sib-mastercard-world-credit-card",
  name: "South Indian Bank Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The SIB Mastercard World Credit Card offers premium travel benefits.",
