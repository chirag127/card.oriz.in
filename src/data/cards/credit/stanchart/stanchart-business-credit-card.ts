...
export const stanchartBusinessCreditCard: CardData = {
  id: "stanchart-business-credit-card",
  name: "Standard Chartered Business Credit Card",
  tagline: "Corporate credit card from Standard Chartered with rewards on all spends.",
  description: "Corporate credit card from Standard Chartered with rewards on all spends. The Standard Chartered Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
