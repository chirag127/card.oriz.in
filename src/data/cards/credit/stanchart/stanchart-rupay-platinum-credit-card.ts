...
export const stanchart_rupay_platinum_credit_card: CardData = {
  id: "stanchart-rupay-platinum-credit-card",
  name: "Standard Chartered Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Standard Chartered RuPay Platinum Credit Card is a lifetime-free domestic card.",
