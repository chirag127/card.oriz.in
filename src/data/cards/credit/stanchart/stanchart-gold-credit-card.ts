...
export const stanchartGoldCreditCard: CardData = {
  id: "stanchart-gold-credit-card",
  name: "Standard Chartered Gold Credit Card",
  tagline: "Gold credit card from Standard Chartered with rewards on all spends.",
  description: "Gold credit card from Standard Chartered with rewards on all spends. The Standard Chartered Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
