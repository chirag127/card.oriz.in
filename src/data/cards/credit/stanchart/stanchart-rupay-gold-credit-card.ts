...
export const stanchart_rupay_gold_credit_card: CardData = {
  id: "stanchart-rupay-gold-credit-card",
  name: "Standard Chartered Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Standard Chartered RuPay Gold Credit Card is a lifetime-free domestic card.",
  ...
  transactionCharges: { currencyMarkupPercent: 3.5, crossBorderFee: 0, dccFeePercent: 2, smsAlertPerMonth: 0, pinRegenerationCharge: 100, physicalStatementCharge: 100, chequeBounceCharge: 500, latePaymentFee: 800, overLimitFee: 500, cashAdvanceFeePercent: 2.5, cashAdvanceFlatFee: 500, interestRatePerMonth: 3.4, annualInterestRate: 40.8 },
  ...
  benefits: [
    ...
    { category: "rewards", title: "Reward Points", description: "Earn 1 reward points per Rs 100 on all transactions", valueStr: "1 RP per Rs 100", valueNum: 0, frequencyStr: "Every transaction", frequencyPerYear: 0, annualValue: 0, conditions: [], isSellable: false, sellValue: 0, isActive: true, activationRequired: false },
  ...
  rewardProgram: { name: "Standard Reward Points", earnRate: "1 RP per Rs 100", pointsPer100: 1, pointValue: 0.2, effectiveCashbackPercent: 0.20, pointsExpiry: "2 years from date of accrual", bonusCategories: [{ category: "All Spends", multiplier: 1, description: "1 RP per Rs 100" }], redemptionOptions: ["Statement credit", "Gift vouchers", "Products"], minRedemptionPoints: 500, rewardRateStr: "0.20%", conditions: [] },
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.stanchart.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 209 0209",
  applyUrl: "https://www.sc.com/in/credit-cards",
