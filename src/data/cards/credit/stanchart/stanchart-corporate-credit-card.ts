...
export const stanchartCorporateCreditCard: CardData = {
  id: "stanchart-corporate-credit-card",
  name: "Standard Chartered Corporate Credit Card",
  tagline: "Corporate credit card from Standard Chartered with rewards on all spends.",
  description: "Corporate credit card from Standard Chartered with rewards on all spends. The Standard Chartered Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Standard Chartered",
  },
  benefits: [
    {
      category: "rewards", title: "Reward Points", description: "2 RP per ₹100",
      valueStr: "2 RP per ₹100", valueNum: 0, frequencyStr: "Every transaction", frequencyPerYear: 0, annualValue: 0,
  ...
  rewardProgram: {
    name: "Standard Chartered Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  welcomeBonus: { available: true, description: "Bonus reward points on card activation", valueStr: "Bonus Points", valueNum: 2500, conditions: [] },
  milestoneBonuses: [{ description: "Bonus on reaching annual spend milestone", spendRequired: 500000, spendPeriod: "Annually", rewardStr: "Bonus Reward Points", rewardNum: 10000 }],
  feeWaivers: [{ description: "Annual fee waived on spending ₹2,50,000 in the preceding year", annualSpendRequired: 250000, waives: "Annual fee of ₹5000" }],
  ...
  value: { highestValue: 100000, averageValue: 50000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 44100, tenYearNetValue: 441000, totalAnnualCharges: 5900, totalAnnualBenefits: 50000, roiPercent: 847 },
  ...
  category: "rewards",
  internationalUsable: true, bestFor: ["Rewards","Cashback"],
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.stanchart.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.stanchart.com/credit-cards",
