...
export const stanchartPlatinumRewardsCreditCard: CardData = {
  id: "stanchart-platinum-rewards-credit-card",
  name: "Standard Chartered Platinum Rewards Credit Card",
  tagline: "Platinum credit card from Standard Chartered with rewards on all spends.",
  description: "Platinum credit card from Standard Chartered with rewards on all spends. The Standard Chartered Platinum Rewards Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
