...
export const iciciVisaSignatureCreditCard: CardData = {
  id: "icici-visa-signature-credit-card",
  name: "ICICI Bank Visa Signature Credit Card",
  tagline: "Signature credit card from ICICI Bank with rewards on all spends.",
  description: "Signature credit card from ICICI Bank with rewards on all spends. The ICICI Bank Visa Signature Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
