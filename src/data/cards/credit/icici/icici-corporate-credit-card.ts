...
export const iciciCorporateCreditCard: CardData = {
  id: "icici-corporate-credit-card",
  name: "ICICI Bank Corporate Credit Card",
  tagline: "Corporate credit card from ICICI Bank with rewards on all spends.",
  description: "Corporate credit card from ICICI Bank with rewards on all spends. The ICICI Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "ICICI Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "ICICI Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.icici.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.icici.com/credit-cards",
