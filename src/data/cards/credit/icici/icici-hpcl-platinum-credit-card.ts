...
export const iciciHpclPlatinumCreditCard: CardData = {
  id: "icici-hpcl-platinum-credit-card",
  name: "ICICI Bank Hpcl Platinum Credit Card",
  tagline: "Platinum credit card from ICICI Bank with rewards on all spends.",
  description: "Platinum credit card from ICICI Bank with rewards on all spends. The ICICI Bank Hpcl Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
