...
export const iciciManchesterUnitedPlatinumCreditCard: CardData = {
  id: "icici-manchester-united-platinum-credit-card",
  name: "ICICI Bank Manchester United Platinum Credit Card",
  tagline: "Platinum credit card from ICICI Bank with rewards on all spends.",
  description: "Platinum credit card from ICICI Bank with rewards on all spends. The ICICI Bank Manchester United Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
