...
export const iciciManchesterUnitedSignatureCreditCard: CardData = {
  id: "icici-manchester-united-signature-credit-card",
  name: "ICICI Bank Manchester United Signature Credit Card",
  tagline: "Signature credit card from ICICI Bank with rewards on all spends.",
  description: "Signature credit card from ICICI Bank with rewards on all spends. The ICICI Bank Manchester United Signature Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
  ...
  welcomeBonus: { available: true, description: "Bonus reward points on card activation", valueStr: "Bonus Points", valueNum: 1500, conditions: [] },
  milestoneBonuses: [{ description: "Bonus on reaching annual spend milestone", spendRequired: 299900, spendPeriod: "Annually", rewardStr: "Bonus Reward Points", rewardNum: 5998 }],
  feeWaivers: [{ description: "Annual fee waived on spending ₹1,49,950 in the preceding year", annualSpendRequired: 149950, waives: "Annual fee of ₹2999" }],
  ...
  value: { highestValue: 59980, averageValue: 29990, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 26451, tenYearNetValue: 264510, totalAnnualCharges: 3539, totalAnnualBenefits: 29990, roiPercent: 847 },
