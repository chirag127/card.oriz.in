...
export const iciciBusinessCreditCard: CardData = {
  id: "icici-business-credit-card",
  name: "ICICI Bank Business Credit Card",
  tagline: "Corporate credit card from ICICI Bank with rewards on all spends.",
  description: "Corporate credit card from ICICI Bank with rewards on all spends. The ICICI Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "credit",
