...
export const indianbank_visa_signature_credit_card: CardData = {
  id: "indianbank-visa-signature-credit-card",
  name: "Indian Bank Visa Signature Credit Card",
  tagline: "Flagship premium card for frequent travelers",
  description: "The Indian Bank Visa Signature Credit Card is the bank's flagship credit card offering premium travel benefits, enhanced lounge access, accelerated rewards, and comprehensive travel insurance for frequent travelers.",
  bank: "Indian Bank",
  bankCode: "indianbank",
  network: "Visa",
  cardType: "credit",
  ...
  loungeAccess: {
    ...
    programs: ["Dreamfolks"],
    conditions: ["Domestic lounge access for primary cardholder"],
  },
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "4 complimentary international airport lounge visits per quarter via Priority Pass",
    ...
    },
    {
      ...
      description: "Earn 5 reward points per Rs 100 on travel, dining, international",
    ...
    },
    {
      ...
      description: "Annual fee waived on spending Rs 4 Lakh annually",
      valueStr: "Fee waiver",
      valueNum: 2500,
      frequencyStr: "Annually",
      frequencyPerYear: 1,
  ...
  rewardProgram: {
    ...
    bonusCategories: [{"category":"Travel","multiplier":5,"description":"5 RP per Rs 100"},{"category":"Dining","multiplier":5,"description":"5 RP per Rs 100"},{"category":"International","multiplier":4,"description":"4 RP per Rs 100"}],
    redemptionOptions: ["Statement credit","Air miles","Gift vouchers","Products"],
  ...
  welcomeBonus: {
    available: true,
    description: "2,500 bonus reward points on joining fee payment",
    valueStr: "2,500 RP",
    valueNum: 2500,
    conditions: ["Spend Rs 15,000 within 60 days"],
  },

  milestoneBonuses: [
    {
      description: "Earn 5,000 bonus points on annual spend of Rs 5 Lakh",
      spendRequired: 500000,
      spendPeriod: "Annually",
      rewardStr: "5,000 bonus points",
      rewardNum: 5000,
    }
  ],
  ...
  feeWaivers: [
    {
      description: "Annual fee waived on annual spend of Rs 4 Lakh",
