...
export const pnbGlobalGoldCreditCard: CardData = {
  ...
  name: "Punjab National Bank Global Gold Credit Card",
  tagline: "Gold credit card from Punjab National Bank with rewards on all spends.",
  description: "Gold credit card from Punjab National Bank with rewards on all spends. The Punjab National Bank Global Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
