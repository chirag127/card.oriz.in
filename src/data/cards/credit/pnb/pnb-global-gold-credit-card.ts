...
export const pnbGlobalGoldCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#4a3a1a and #9F8E4F gradient",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Complimentary domestic lounge access: 1 per year",
      valueStr: "1 per year",
      valueNum: 1000,
  ...
  welcomeBonus: {
    available: true,
    description: "250 bonus reward points",
    valueStr: "250 bonus reward points",
    valueNum: 0,
    conditions: [],
  },
