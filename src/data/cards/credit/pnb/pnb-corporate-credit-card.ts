...
export const pnbCorporateCreditCard: CardData = {
  id: "pnb-corporate-credit-card",
  name: "Punjab National Bank Corporate Credit Card",
  tagline: "Corporate credit card from Punjab National Bank with rewards on all spends.",
  description: "Corporate credit card from Punjab National Bank with rewards on all spends. The Punjab National Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Punjab National Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Punjab National Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.pnb.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.pnb.com/credit-cards",
