...
export const pnbPatanjaliRupayPlatinumCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#2a5a3e and #4FAE7F gradient",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Complimentary domestic lounge access: 2 per quarter",
      valueStr: "2 per quarter",
      valueNum: 1000,
