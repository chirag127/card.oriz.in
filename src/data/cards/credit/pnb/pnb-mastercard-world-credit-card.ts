...
export const pnb_mastercard_world_credit_card: CardData = {
  id: "pnb-mastercard-world-credit-card",
  name: "Punjab National Bank Mastercard World Credit Card",
  tagline: "Premium international card",
  description: "The PNB Mastercard World Credit Card offers premium travel benefits and lounge access.",
