...
export const pnbRupayMillennialCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#3a1a5e and #7F4EDF gradient",
  ...
  charges: [
    { label: "Joining Fee", amount: 399, amountWithGst: 471, note: "Excluding GST" },
  ...
  welcomeBonus: {
    available: true,
    description: "300+ reward points on activation",
    valueStr: "300+ reward points on activation",
    valueNum: 0,
    conditions: [],
  },
