...
export const pnbBusinessCreditCard: CardData = {
  id: "pnb-business-credit-card",
  name: "Punjab National Bank Business Credit Card",
  tagline: "Corporate credit card from Punjab National Bank with rewards on all spends.",
  description: "Corporate credit card from Punjab National Bank with rewards on all spends. The Punjab National Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
