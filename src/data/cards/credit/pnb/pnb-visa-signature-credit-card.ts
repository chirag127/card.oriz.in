...
export const pnb_visa_signature_credit_card: CardData = {
  id: "pnb-visa-signature-credit-card",
  name: "Punjab National Bank Visa Signature Credit Card",
  tagline: "Premium card with enhanced benefits",
  description: "The PNB Visa Signature Credit Card offers premium rewards, lounge access, and travel insurance.",
  ...
  rewardProgram: { name: "Punjab Reward Points", earnRate: "4 RP per Rs 100", pointsPer100: 4, pointValue: 0.3, effectiveCashbackPercent: 1.20, pointsExpiry: "2 years from date of accrual", bonusCategories: [{ category: "All Spends", multiplier: 4, description: "4 RP per Rs 100" }], redemptionOptions: ["Statement credit", "Gift vouchers", "Products"], minRedemptionPoints: 1000, rewardRateStr: "1.20%", conditions: [] },
  ...
  value: { highestValue: 25000, averageValue: 10000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 216640, tenYearNetValue: 2166400, totalAnnualCharges: 2360, totalAnnualBenefits: 219000, roiPercent: 9280 },
