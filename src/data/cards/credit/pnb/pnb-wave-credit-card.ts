...
export const pnbWaveCreditCard: CardData = {
  id: "pnb-wave-credit-card",
  name: "Punjab National Bank Wave Credit Card",
  tagline: "Platinum credit card from Punjab National Bank with rewards on all spends.",
  description: "Platinum credit card from Punjab National Bank with rewards on all spends. The Punjab National Bank Wave Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
