...
export const cub_rupay_gold_credit_card: CardData = {
  id: "cub-rupay-gold-credit-card",
  name: "City Union Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The CUB RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
