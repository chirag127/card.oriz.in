...
export const cub_mastercard_platinum_credit_card: CardData = {
  id: "cub-mastercard-platinum-credit-card",
  name: "City Union Bank Mastercard Platinum Credit Card",
  tagline: "Premium card with lounge access",
  description: "The CUB Mastercard Platinum Credit Card offers domestic lounge access and enhanced rewards.",
  ...
  customerCareNumber: "1800 425 4567",
  applyUrl: "https://www.cityunionbank.com/credit-cards.aspx",
