...
export const cubVisaPlatinumCreditCard: CardData = {
  id: "cub-visa-platinum-credit-card",
  name: "City Union Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from City Union Bank with balanced rewards.",
  description: "Mid-range credit card from City Union Bank with balanced rewards. The City Union Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "City Union Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
