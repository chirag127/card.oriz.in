...
export const cubVisaSignatureCreditCard: CardData = {
  id: "cub-visa-signature-credit-card",
  name: "City Union Bank Visa Signature Credit Card",
  tagline: "Premium credit card from City Union Bank with travel and rewards benefits.",
  description: "Premium credit card from City Union Bank with travel and rewards benefits. The City Union Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "City Union Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "City Union Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.cub.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.cub.com/credit-cards",
