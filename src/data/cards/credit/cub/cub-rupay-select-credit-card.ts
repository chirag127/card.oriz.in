...
export const cubRupaySelectCreditCard: CardData = {
  id: "cub-rupay-select-credit-card",
  name: "City Union Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from City Union Bank with UPI support.",
  description: "Lifetime free RuPay credit card from City Union Bank with UPI support. The City Union Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "City Union Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
