...
export const cub_visa_gold_credit_card: CardData = {
  id: "cub-visa-gold-credit-card",
  name: "City Union Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The CUB Visa Gold Credit Card is an entry-level international card with basic rewards.",
