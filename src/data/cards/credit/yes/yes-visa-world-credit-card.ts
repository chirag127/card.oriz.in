...
export const yes_visa_world_credit_card: CardData = {
  id: "yes-visa-world-credit-card",
  name: "Yes Bank Visa World Credit Card",
  tagline: "Premium international card",
  description: "The Yes Bank Visa World Credit Card offers premium travel benefits and lounge access.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
