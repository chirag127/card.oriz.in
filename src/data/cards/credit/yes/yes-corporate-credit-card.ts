...
export const yesCorporateCreditCard: CardData = {
  id: "yes-corporate-credit-card",
  name: "Yes Bank Corporate Credit Card",
  tagline: "Corporate credit card from Yes Bank with rewards on all spends.",
  description: "Corporate credit card from Yes Bank with rewards on all spends. The Yes Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Yes Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Yes Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.yes.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.yes.com/credit-cards",
