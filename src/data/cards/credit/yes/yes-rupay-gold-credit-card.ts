...
export const yes_rupay_gold_credit_card: CardData = {
  id: "yes-rupay-gold-credit-card",
  name: "Yes Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Yes Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "RuPay",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.yes.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 1200",
  applyUrl: "https://www.yesbank.in/credit-cards",
