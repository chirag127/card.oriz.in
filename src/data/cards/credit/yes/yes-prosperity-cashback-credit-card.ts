...
export const yesProsperityCashbackCreditCard: CardData = {
  id: "yes-prosperity-cashback-credit-card",
  name: "Yes Bank Prosperity Cashback Credit Card",
  tagline: "Platinum credit card from Yes Bank with rewards on all spends.",
  description: "Platinum credit card from Yes Bank with rewards on all spends. The Yes Bank Prosperity Cashback Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
