...
export const yesBusinessCreditCard: CardData = {
  id: "yes-business-credit-card",
  name: "Yes Bank Business Credit Card",
  tagline: "Corporate credit card from Yes Bank with rewards on all spends.",
  description: "Corporate credit card from Yes Bank with rewards on all spends. The Yes Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
