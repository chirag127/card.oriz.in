...
export const yesFuelCreditCard: CardData = {
  id: "yes-fuel-credit-card",
  name: "Yes Bank Fuel Credit Card",
  tagline: "Platinum credit card from Yes Bank with rewards on all spends.",
  description: "Platinum credit card from Yes Bank with rewards on all spends. The Yes Bank Fuel Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
