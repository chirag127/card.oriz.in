...
export const yes_mastercard_gold_credit_card: CardData = {
  id: "yes-mastercard-gold-credit-card",
  name: "Yes Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The Yes Bank Mastercard Gold Credit Card offers basic international features.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Mastercard",
  cardType: "credit",
