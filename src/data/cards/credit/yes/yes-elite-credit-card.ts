...
export const yesEliteCreditCard: CardData = {
  id: "yes-elite-credit-card",
  name: "Yes Bank Elite Credit Card",
  tagline: "Signature credit card from Yes Bank with rewards on all spends.",
  description: "Signature credit card from Yes Bank with rewards on all spends. The Yes Bank Elite Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "credit",
