...
export const yes_rupay_platinum_credit_card: CardData = {
  id: "yes-rupay-platinum-credit-card",
  name: "Yes Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Yes Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI support.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "RuPay",
  cardType: "credit",
