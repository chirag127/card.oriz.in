...
export const rbl_mastercard_gold_credit_card: CardData = {
  id: "rbl-mastercard-gold-credit-card",
  name: "RBL Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The RBL Bank Mastercard Gold Credit Card offers basic international features.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Mastercard",
  cardType: "credit",
