...
export const rblPlatinumPlusCreditCard: CardData = {
  id: "rbl-platinum-plus-credit-card",
  name: "RBL Bank Platinum Plus Credit Card",
  tagline: "Platinum credit card from RBL Bank with rewards on all spends.",
  description: "Platinum credit card from RBL Bank with rewards on all spends. The RBL Bank Platinum Plus Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Visa",
  cardType: "credit",
