...
export const rblMaximaCreditCard: CardData = {
  id: "rbl-maxima-credit-card",
  name: "RBL Bank Maxima Credit Card",
  tagline: "Platinum credit card from RBL Bank with rewards on all spends.",
  description: "Platinum credit card from RBL Bank with rewards on all spends. The RBL Bank Maxima Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Visa",
  cardType: "credit",
