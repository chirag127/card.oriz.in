...
export const rbl_rupay_platinum_credit_card: CardData = {
  id: "rbl-rupay-platinum-credit-card",
  name: "RBL Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The RBL Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "RuPay",
  cardType: "credit",
