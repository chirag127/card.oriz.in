...
export const rblCorporateCreditCard: CardData = {
  id: "rbl-corporate-credit-card",
  name: "RBL Bank Corporate Credit Card",
  tagline: "Corporate credit card from RBL Bank with rewards on all spends.",
  description: "Corporate credit card from RBL Bank with rewards on all spends. The RBL Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "RBL Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "RBL Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.rbl.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.rbl.com/credit-cards",
