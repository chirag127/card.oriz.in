...
export const rblTitaniumCreditCard: CardData = {
  id: "rbl-titanium-credit-card",
  name: "RBL Bank Titanium Credit Card",
  tagline: "Platinum credit card from RBL Bank with rewards on all spends.",
  description: "Platinum credit card from RBL Bank with rewards on all spends. The RBL Bank Titanium Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Visa",
  cardType: "credit",
