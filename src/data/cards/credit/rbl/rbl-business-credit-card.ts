...
export const rblBusinessCreditCard: CardData = {
  id: "rbl-business-credit-card",
  name: "RBL Bank Business Credit Card",
  tagline: "Corporate credit card from RBL Bank with rewards on all spends.",
  description: "Corporate credit card from RBL Bank with rewards on all spends. The RBL Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "Visa",
  cardType: "credit",
