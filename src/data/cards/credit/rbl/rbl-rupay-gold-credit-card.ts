...
export const rbl_rupay_gold_credit_card: CardData = {
  id: "rbl-rupay-gold-credit-card",
  name: "RBL Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The RBL Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  bank: "RBL Bank",
  bankCode: "rbl",
  network: "RuPay",
  cardType: "credit",
