...
export const dhanlaxmi_mastercard_world_credit_card: CardData = {
  id: "dhanlaxmi-mastercard-world-credit-card",
  name: "Dhanlaxmi Bank Mastercard World Credit Card",
  tagline: "Premium international card with travel benefits",
  description: "The Dhanlaxmi Bank Mastercard World Credit Card offers international lounge access, enhanced rewards, and comprehensive travel insurance.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "Mastercard",
  cardType: "credit",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "6 complimentary domestic airport lounge visits per quarter",
  ...
  welcomeBonus: {
    available: true,
    description: "2500 bonus reward points on card activation",
    valueStr: "2,500 RP",
    valueNum: 2500,
  ...
  feeWaivers: [{
    ...
    waives: "Annual fee of Rs 2,500 + GST",
  }],
  ...
  value: { highestValue: 25000, averageValue: 15000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 216050, tenYearNetValue: 2160500, totalAnnualCharges: 2950, totalAnnualBenefits: 219000, roiPercent: 7424 },
  ...
  customerCareNumber: "1800 425 2244",
  applyUrl: "https://www.dhanlaxmibank.com/credit-cards.aspx",
