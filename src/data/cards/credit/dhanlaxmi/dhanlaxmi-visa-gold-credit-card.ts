...
export const dhanlaxmi_visa_gold_credit_card: CardData = {
  id: "dhanlaxmi-visa-gold-credit-card",
  name: "Dhanlaxmi Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The Dhanlaxmi Bank Visa Gold Credit Card is an entry-level international card with basic rewards.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "Visa",
  cardType: "credit",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.dhanlaxmi.com/credit-cards"], lastVerified: "2026-04-08" },
