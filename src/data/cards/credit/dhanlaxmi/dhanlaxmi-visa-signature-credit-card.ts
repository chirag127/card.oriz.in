...
export const dhanlaxmiVisaSignatureCreditCard: CardData = {
  id: "dhanlaxmi-visa-signature-credit-card",
  name: "Dhanlaxmi Bank Visa Signature Credit Card",
  tagline: "Premium credit card from Dhanlaxmi Bank with travel and rewards benefits.",
  description: "Premium credit card from Dhanlaxmi Bank with travel and rewards benefits. The Dhanlaxmi Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Dhanlaxmi Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Dhanlaxmi Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.dhanlaxmi.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.dhanlaxmi.com/credit-cards",
