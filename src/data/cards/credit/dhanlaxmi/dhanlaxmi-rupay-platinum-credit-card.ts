...
export const dhanlaxmi_rupay_platinum_credit_card: CardData = {
  id: "dhanlaxmi-rupay-platinum-credit-card",
  name: "Dhanlaxmi Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The Dhanlaxmi Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI support.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "RuPay",
  cardType: "credit",
