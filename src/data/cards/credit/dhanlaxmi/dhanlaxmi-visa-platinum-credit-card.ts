...
export const dhanlaxmiVisaPlatinumCreditCard: CardData = {
  id: "dhanlaxmi-visa-platinum-credit-card",
  name: "Dhanlaxmi Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Dhanlaxmi Bank with balanced rewards.",
  description: "Mid-range credit card from Dhanlaxmi Bank with balanced rewards. The Dhanlaxmi Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "Visa",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "Dhanlaxmi Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
