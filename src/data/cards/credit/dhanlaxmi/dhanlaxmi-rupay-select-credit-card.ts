...
export const dhanlaxmiRupaySelectCreditCard: CardData = {
  id: "dhanlaxmi-rupay-select-credit-card",
  name: "Dhanlaxmi Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Dhanlaxmi Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Dhanlaxmi Bank with UPI support. The Dhanlaxmi Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  bank: "Dhanlaxmi Bank",
  bankCode: "dhanlaxmi",
  network: "RuPay",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "Dhanlaxmi Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
