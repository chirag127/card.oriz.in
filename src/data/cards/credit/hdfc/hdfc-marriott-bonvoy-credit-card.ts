...
export const hdfcMarriottBonvoyCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#2a2a3e and #5F6EAF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Bonvoy points on spends on all spends",
      valueStr: "Bonvoy points on spends",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Bonvoy points on spends",
    pointsPer100: 4,
    pointValue: 0.25,
    ...
    rewardRateStr: "Bonvoy points on spends",
  },

  welcomeBonus: {
    available: true,
    description: "Free night award",
    valueStr: "Free night award",
    valueNum: 1500,
    conditions: [],
  },
  ...
  feeWaivers: [
    { description: "Annual fee waived on spending ₹1,50,000 in preceding year", annualSpendRequired: 150000, waives: "Annual fee of ₹3000" }
  ],
  ...
  value: {
    ...
    annualNetValue: 26460,
    tenYearNetValue: 264600,
