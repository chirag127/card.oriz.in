...
export const hdfcBusinessRegaliaCreditCard: CardData = {
  id: "hdfc-business-regalia-credit-card",
  name: "HDFC Bank Business Regalia Credit Card",
  tagline: "Corporate credit card from HDFC Bank with rewards on all spends.",
  description: "Corporate credit card from HDFC Bank with rewards on all spends. The HDFC Bank Business Regalia Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "HDFC Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "HDFC Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.hdfc.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.hdfc.com/credit-cards",
