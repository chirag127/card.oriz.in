...
export const hdfcSwiggyCreditCard: CardData = {
  ...
  tagline: "Up to 10% cashback on Swiggy with a low annual fee",
  description: "The Swiggy HDFC Bank Credit Card is an entry-level co-branded credit card offering 10% cashback on Swiggy orders, 5% cashback on select online merchants, and 1% on all other spends. An affordable option for frequent Swiggy users who want to save on food delivery.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "credit",
  ...
  welcomeBonus: {
    available: true,
    description: "Complimentary Swiggy One membership for 1 month on card activation",
    valueStr: "Swiggy One 1 month",
    valueNum: 399,
  ...
  dataQuality: {
    ...
    sourceUrls: [
      ...
      "https://www.paisabazaar.com/credit-card/swiggy-hdfc-credit-card/",
    ],
