...
export const hdfcZomatoCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#E23744 and #FF6B6B gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 10% Zomato, 5% online, 1% others on all spends",
      valueStr: "10% Zomato, 5% online, 1% others",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "10% Zomato, 5% online, 1% others",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "10% Zomato, 5% online, 1% others",
  },

  welcomeBonus: {
    available: true,
    description: "Zomato Gold trial",
    valueStr: "Zomato Gold trial",
    valueNum: 0,
    conditions: [],
  },
