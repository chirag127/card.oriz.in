...
export const hdfcCorporateCreditCard: CardData = {
  id: "hdfc-corporate-credit-card",
  name: "HDFC Bank Corporate Credit Card",
  tagline: "Corporate credit card from HDFC Bank with rewards on all spends.",
  description: "Corporate credit card from HDFC Bank with rewards on all spends. The HDFC Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "credit",
