...
export const hdfcUpstoxCreditCard: CardData = {
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Upstox credits on spends on all spends",
      valueStr: "Upstox credits on spends",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Upstox credits on spends",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "Upstox credits on spends",
  },

  welcomeBonus: {
    available: true,
    description: "Upstox credits",
    valueStr: "Upstox credits",
    valueNum: 0,
    conditions: [],
  },
