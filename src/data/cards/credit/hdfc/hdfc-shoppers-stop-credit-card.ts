...
export const hdfcShoppersStopCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#4a2a2a and #BF5F5F gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Accelerated at Shoppers Stop on all spends",
      valueStr: "Accelerated at Shoppers Stop",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Accelerated at Shoppers Stop",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "Accelerated at Shoppers Stop",
  },

  welcomeBonus: {
    available: false,
    description: "5% welcome discount",
    valueStr: "5% welcome discount",
    valueNum: 0,
    conditions: [],
  },
