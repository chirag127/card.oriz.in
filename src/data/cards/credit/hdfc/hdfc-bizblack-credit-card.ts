...
export const hdfcBizblackCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#1a1a2e and #3F4EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 4.3% reward rate on all spends",
      valueStr: "4.3% reward rate",
      valueNum: 0,
