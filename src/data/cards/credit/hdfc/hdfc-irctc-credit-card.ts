...
export const hdfcIrctcCreditCard: CardData = {
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5% on IRCTC bookings on all spends",
      valueStr: "5% on IRCTC bookings",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    rewardRateStr: "5% on IRCTC bookings",
  },

  welcomeBonus: {
    available: true,
    description: "Free ticket on milestone",
    valueStr: "Free ticket on milestone",
    valueNum: 0,
    conditions: [],
  },
