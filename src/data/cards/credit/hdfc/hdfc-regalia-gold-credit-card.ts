...
export const hdfcRegaliaGoldCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#4a3a1a and #BF9F4F gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5X RP on select brands on all spends",
      valueStr: "5X RP on select brands",
      valueNum: 0,
    ...
    },
    {
      ...
      description: "Complimentary domestic lounge access: Via milestones",
      valueStr: "Via milestones",
      valueNum: 2000,
  ...
  rewardProgram: {
    ...
    earnRate: "5X RP on select brands",
    pointsPer100: 4,
    pointValue: 0.25,
    ...
    rewardRateStr: "5X RP on select brands",
  },

  welcomeBonus: {
    available: true,
    description: "Swiggy One + MMT Black Gold",
    valueStr: "Swiggy One + MMT Black Gold",
    valueNum: 1250,
    conditions: [],
  },
