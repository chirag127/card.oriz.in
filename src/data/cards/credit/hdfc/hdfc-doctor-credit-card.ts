...
export const hdfcDoctorCreditCard: CardData = {
  id: "hdfc-doctor-credit-card",
  name: "HDFC Bank Doctor Credit Card",
  tagline: "Platinum credit card from HDFC Bank with rewards on all spends.",
  description: "Platinum credit card from HDFC Bank with rewards on all spends. The HDFC Bank Doctor Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "credit",
