...
export const hdfcRupayPlatinumCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#3a3a5e and #6F7EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn Enhanced rewards on all spends on all spends",
      valueStr: "Enhanced rewards on all spends",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "Enhanced rewards on all spends",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "Enhanced rewards on all spends",
  },

  welcomeBonus: {
    available: true,
    description: "1,000 bonus reward points",
    valueStr: "1,000 bonus reward points",
    valueNum: 0,
    conditions: [],
  },
