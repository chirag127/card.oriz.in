...
export const hdfcMoneybackPlusCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#2a3a4e and #5F7EAF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 10X dining/grocery, 2X utility on all spends",
      valueStr: "10X dining/grocery, 2X utility",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "10X dining/grocery, 2X utility",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "10X dining/grocery, 2X utility",
  },

  welcomeBonus: {
    available: true,
    description: "500 CashPoints",
