...
export const hdfcMillenniaCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#1a3a5e and #4F7EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5% Amazon/Flipkart, 1% others on all spends",
      valueStr: "5% Amazon/Flipkart, 1% others",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5% Amazon/Flipkart, 1% others",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "5% Amazon/Flipkart, 1% others",
  },

  welcomeBonus: {
    available: true,
    description: "5,000 CashPoints",
    valueStr: "5,000 CashPoints",
    valueNum: 500,
    conditions: [],
  },
