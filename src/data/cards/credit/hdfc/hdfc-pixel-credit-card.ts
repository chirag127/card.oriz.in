...
export const hdfcPixelCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#3a2a5e and #7F5EBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5% cashback select (capped ₹500/cat/month) on all spends",
      valueStr: "5% cashback select (capped ₹500/cat/month)",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5% cashback select (capped ₹500/cat/month)",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "5% cashback select (capped ₹500/cat/month)",
  },

  welcomeBonus: {
    available: true,
    description: "500 Pixel Coins",
    valueStr: "500 Pixel Coins",
    valueNum: 0,
    conditions: [],
  },
