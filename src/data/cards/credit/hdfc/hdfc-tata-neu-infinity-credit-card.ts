...
export const hdfcTataNeuInfinityCreditCard: CardData = {
  ...
  bin: "",
  material: "Plastic",
  colorScheme: "#4a1a5e and #9F5FBF gradient",
  ...
  benefits: [
    {
      category: "rewards",
      title: "Reward Points",
      description: "Earn 5% NeuCoins Tata, 1.5% others on all spends",
      valueStr: "5% NeuCoins Tata, 1.5% others",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "5% NeuCoins Tata, 1.5% others",
    pointsPer100: 2,
    pointValue: 0.25,
    ...
    rewardRateStr: "5% NeuCoins Tata, 1.5% others",
  },

  welcomeBonus: {
    available: true,
    description: "5,000 NeuCoins",
    valueStr: "5,000 NeuCoins",
    valueNum: 750,
    conditions: [],
  },
