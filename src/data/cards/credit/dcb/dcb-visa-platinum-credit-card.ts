...
export const dcbVisaPlatinumCreditCard: CardData = {
  id: "dcb-visa-platinum-credit-card",
  name: "DCB Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from DCB Bank with balanced rewards.",
  description: "Mid-range credit card from DCB Bank with balanced rewards. The DCB Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "DCB Bank",
  bankCode: "dcb",
  network: "Visa",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "DCB Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
