...
export const dcb_visa_gold_credit_card: CardData = {
  id: "dcb-visa-gold-credit-card",
  name: "DCB Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The DCB Bank Visa Gold Credit Card is an entry-level international card with basic rewards.",
  bank: "DCB Bank",
  bankCode: "dcb",
  network: "Visa",
  cardType: "credit",
