...
export const dcbVisaSignatureCreditCard: CardData = {
  id: "dcb-visa-signature-credit-card",
  name: "DCB Bank Visa Signature Credit Card",
  tagline: "Premium credit card from DCB Bank with travel and rewards benefits.",
  description: "Premium credit card from DCB Bank with travel and rewards benefits. The DCB Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  bank: "DCB Bank",
  bankCode: "dcb",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "DCB Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "DCB Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.dcb.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.dcb.com/credit-cards",
