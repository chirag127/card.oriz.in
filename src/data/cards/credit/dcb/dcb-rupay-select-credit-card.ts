...
export const dcbRupaySelectCreditCard: CardData = {
  id: "dcb-rupay-select-credit-card",
  name: "DCB Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from DCB Bank with UPI support.",
  description: "Lifetime free RuPay credit card from DCB Bank with UPI support. The DCB Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  bank: "DCB Bank",
  bankCode: "dcb",
  network: "RuPay",
  cardType: "credit",
  ...
  rewardProgram: {
    name: "DCB Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
