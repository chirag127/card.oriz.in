...
export const kotakSolitaireCreditCard: CardData = {
  id: "kotak-solitaire-credit-card",
  name: "Kotak Mahindra Bank Solitaire Credit Card",
  tagline: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Solitaire Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
