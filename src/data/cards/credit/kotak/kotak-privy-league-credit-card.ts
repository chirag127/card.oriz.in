...
export const kotakPrivyLeagueCreditCard: CardData = {
  id: "kotak-privy-league-credit-card",
  name: "Kotak Mahindra Bank Privy League Credit Card",
  tagline: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Privy League Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
