...
export const kotakEssentiaCreditCard: CardData = {
  id: "kotak-essentia-credit-card",
  name: "Kotak Mahindra Bank Essentia Credit Card",
  tagline: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Platinum credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Essentia Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
