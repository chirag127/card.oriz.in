...
export const kotak_rupay_gold_credit_card: CardData = {
  id: "kotak-rupay-gold-credit-card",
  name: "Kotak Mahindra Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The Kotak RuPay Gold Credit Card is a lifetime-free domestic card with basic rewards.",
