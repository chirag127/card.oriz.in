...
export const kotakGoldCreditCard: CardData = {
  id: "kotak-gold-credit-card",
  name: "Kotak Mahindra Bank Gold Credit Card",
  tagline: "Gold credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Gold credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
