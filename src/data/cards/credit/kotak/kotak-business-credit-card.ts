...
export const kotakBusinessCreditCard: CardData = {
  id: "kotak-business-credit-card",
  name: "Kotak Mahindra Bank Business Credit Card",
  tagline: "Corporate credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Corporate credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
