...
export const kotak_visa_world_credit_card: CardData = {
  id: "kotak-visa-world-credit-card",
  name: "Kotak Mahindra Bank Visa World Credit Card",
  tagline: "Premium international card with travel benefits",
  description: "The Kotak Visa World Credit Card offers international lounge access, enhanced rewards, and travel insurance.",
