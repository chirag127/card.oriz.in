...
export const kotakCorporateCreditCard: CardData = {
  id: "kotak-corporate-credit-card",
  name: "Kotak Mahindra Bank Corporate Credit Card",
  tagline: "Corporate credit card from Kotak Mahindra Bank with rewards on all spends.",
  description: "Corporate credit card from Kotak Mahindra Bank with rewards on all spends. The Kotak Mahindra Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Kotak Mahindra Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Kotak Mahindra Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.kotak.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.kotak.com/credit-cards",
