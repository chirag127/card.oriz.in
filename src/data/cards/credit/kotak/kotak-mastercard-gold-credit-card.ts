...
export const kotak_mastercard_gold_credit_card: CardData = {
  id: "kotak-mastercard-gold-credit-card",
  name: "Kotak Mahindra Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The Kotak Mastercard Gold Credit Card is an entry-level international card with basic rewards.",
