...
export const psbVisaSignatureCreditCard: CardData = {
  id: "psb-visa-signature-credit-card",
  name: "Punjab & Sind Bank Visa Signature Credit Card",
  tagline: "Premium credit card from Punjab & Sind Bank with travel and rewards benefits.",
  description: "Premium credit card from Punjab & Sind Bank with travel and rewards benefits. The Punjab & Sind Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Punjab & Sind Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Punjab & Sind Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.psb.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.psb.com/credit-cards",
