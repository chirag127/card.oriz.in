...
export const psbRupaySelectCreditCard: CardData = {
  id: "psb-rupay-select-credit-card",
  name: "Punjab & Sind Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Punjab & Sind Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Punjab & Sind Bank with UPI support. The Punjab & Sind Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Punjab & Sind Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
