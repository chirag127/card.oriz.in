...
export const psb_visa_gold_credit_card: CardData = {
  id: "psb-visa-gold-credit-card",
  name: "Punjab and Sind Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The PSB Visa Gold Credit Card is an entry-level international credit card with basic rewards and fuel surcharge waiver.",
