...
export const psbVisaPlatinumCreditCard: CardData = {
  id: "psb-visa-platinum-credit-card",
  name: "Punjab & Sind Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Punjab & Sind Bank with balanced rewards.",
  description: "Mid-range credit card from Punjab & Sind Bank with balanced rewards. The Punjab & Sind Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Punjab & Sind Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
