...
export const psb_rupay_gold_credit_card: CardData = {
  id: "psb-rupay-gold-credit-card",
  name: "Punjab and Sind Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The PSB RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
