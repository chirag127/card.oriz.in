...
export const kvb_visa_gold_credit_card: CardData = {
  id: "kvb-visa-gold-credit-card",
  name: "Karur Vysya Bank Visa Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The KVB Visa Gold Credit Card is an entry-level international card with basic rewards and fuel surcharge waiver.",
