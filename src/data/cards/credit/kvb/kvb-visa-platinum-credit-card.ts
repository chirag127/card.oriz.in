...
export const kvbVisaPlatinumCreditCard: CardData = {
  id: "kvb-visa-platinum-credit-card",
  name: "Karur Vysya Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Karur Vysya Bank with balanced rewards.",
  description: "Mid-range credit card from Karur Vysya Bank with balanced rewards. The Karur Vysya Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Karur Vysya Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
