...
export const kvb_rupay_gold_credit_card: CardData = {
  id: "kvb-rupay-gold-credit-card",
  name: "Karur Vysya Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The KVB RuPay Gold Credit Card is a lifetime-free domestic card with UPI support.",
