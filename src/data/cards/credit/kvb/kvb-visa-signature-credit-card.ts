...
export const kvbVisaSignatureCreditCard: CardData = {
  id: "kvb-visa-signature-credit-card",
  name: "Karur Vysya Bank Visa Signature Credit Card",
  tagline: "Premium credit card from Karur Vysya Bank with travel and rewards benefits.",
  description: "Premium credit card from Karur Vysya Bank with travel and rewards benefits. The Karur Vysya Bank Visa Signature Credit Card offers 3 RP per ₹100 and is best suited for Rewards, Travel purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "Karur Vysya Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "Karur Vysya Bank Rewards", earnRate: "3 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.kvb.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.kvb.com/credit-cards",
