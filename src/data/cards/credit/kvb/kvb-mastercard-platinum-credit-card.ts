...
export const kvb_mastercard_platinum_credit_card: CardData = {
  id: "kvb-mastercard-platinum-credit-card",
  name: "Karur Vysya Bank Mastercard Platinum Credit Card",
  tagline: "Premium card with lounge access",
  description: "The KVB Mastercard Platinum Credit Card offers domestic lounge access and accelerated rewards.",
  ...
  customerCareNumber: "1800 103 0303",
  applyUrl: "https://www.kvb.co.in/credit-cards.aspx",
