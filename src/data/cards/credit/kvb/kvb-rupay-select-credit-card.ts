...
export const kvbRupaySelectCreditCard: CardData = {
  id: "kvb-rupay-select-credit-card",
  name: "Karur Vysya Bank RuPay Select Credit Card",
  tagline: "Lifetime free RuPay credit card from Karur Vysya Bank with UPI support.",
  description: "Lifetime free RuPay credit card from Karur Vysya Bank with UPI support. The Karur Vysya Bank RuPay Select Credit Card offers 1 RP per ₹100 and is best suited for UPI, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Karur Vysya Bank Rewards", earnRate: "1 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
