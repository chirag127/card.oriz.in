...
export const iobVisaPlatinumCreditCard: CardData = {
  id: "iob-visa-platinum-credit-card",
  name: "Indian Overseas Bank Visa Platinum Credit Card",
  tagline: "Mid-range credit card from Indian Overseas Bank with balanced rewards.",
  description: "Mid-range credit card from Indian Overseas Bank with balanced rewards. The Indian Overseas Bank Visa Platinum Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  rewardProgram: {
    name: "Indian Overseas Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
