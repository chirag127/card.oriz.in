...
export const iob_rupay_platinum_credit_card: CardData = {
  id: "iob-rupay-platinum-credit-card",
  name: "Indian Overseas Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The IOB RuPay Platinum Credit Card is a lifetime-free domestic card with UPI support and basic rewards.",
