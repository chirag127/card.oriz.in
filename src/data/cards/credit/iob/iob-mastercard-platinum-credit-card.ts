...
export const iob_mastercard_platinum_credit_card: CardData = {
  id: "iob-mastercard-platinum-credit-card",
  name: "Indian Overseas Bank Mastercard Platinum Credit Card",
  tagline: "Premium card with lounge access",
  description: "The IOB Mastercard Platinum Credit Card offers domestic lounge access, accelerated rewards, and travel insurance.",
  ...
  customerCareNumber: "1800 425 6060",
  applyUrl: "https://www.iob.in/credit-cards.aspx",
