...
export const iob_visa_gold_credit_card: CardData = {
  id: "iob-visa-gold-credit-card",
  name: "Indian Overseas Bank Visa Gold Credit Card",
  tagline: "Entry-level international card with basic benefits",
  description: "The IOB Visa Gold Credit Card is an entry-level international credit card with basic rewards and travel insurance.",
