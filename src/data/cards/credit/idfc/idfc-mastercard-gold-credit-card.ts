...
export const idfc_mastercard_gold_credit_card: CardData = {
  id: "idfc-mastercard-gold-credit-card",
  name: "IDFC FIRST Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The IDFC FIRST Bank Mastercard Gold Credit Card offers basic international features.",
