...
export const idfcClassicUpiCreditCard: CardData = {
  id: "idfc-classic-upi-credit-card",
  name: "IDFC First Bank Classic Upi Credit Card",
  tagline: "Platinum credit card from IDFC First Bank with rewards on all spends.",
  description: "Platinum credit card from IDFC First Bank with rewards on all spends. The IDFC First Bank Classic Upi Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
