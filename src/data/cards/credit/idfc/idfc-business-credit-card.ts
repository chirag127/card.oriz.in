...
export const idfcBusinessCreditCard: CardData = {
  id: "idfc-business-credit-card",
  name: "IDFC First Bank Business Credit Card",
  tagline: "Corporate credit card from IDFC First Bank with rewards on all spends.",
  description: "Corporate credit card from IDFC First Bank with rewards on all spends. The IDFC First Bank Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
