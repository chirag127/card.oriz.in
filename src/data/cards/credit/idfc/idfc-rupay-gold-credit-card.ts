...
export const idfc_rupay_gold_credit_card: CardData = {
  id: "idfc-rupay-gold-credit-card",
  name: "IDFC FIRST Bank RuPay Gold Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The IDFC FIRST Bank RuPay Gold Credit Card is a lifetime-free domestic card.",
  ...
  dataQuality: { status: "unverified", verifiedFields: ["charges", "eligibility", "limits"], unverifiedFields: ["benefits", "rewards", "loungeAccess"], sourceUrls: ["https://www.idfc.com/credit-cards"], lastVerified: "2026-04-08" },

  customerCareNumber: "1800 10 2004",
