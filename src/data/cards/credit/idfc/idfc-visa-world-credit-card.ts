...
export const idfc_visa_world_credit_card: CardData = {
  id: "idfc-visa-world-credit-card",
  name: "IDFC FIRST Bank Visa World Credit Card",
  tagline: "Premium international card",
  description: "The IDFC FIRST Bank Visa World Credit Card offers premium travel benefits.",
