...
export const idfcCorporateCreditCard: CardData = {
  id: "idfc-corporate-credit-card",
  name: "IDFC First Bank Corporate Credit Card",
  tagline: "Corporate credit card from IDFC First Bank with rewards on all spends.",
  description: "Corporate credit card from IDFC First Bank with rewards on all spends. The IDFC First Bank Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "IDFC First Bank",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "IDFC First Bank Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.idfc.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.idfc.com/credit-cards",
