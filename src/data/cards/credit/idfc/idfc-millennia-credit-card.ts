...
export const idfcMillenniaCreditCard: CardData = {
  id: "idfc-millennia-credit-card",
  name: "IDFC First Bank Millennia Credit Card",
  tagline: "Platinum credit card from IDFC First Bank with rewards on all spends.",
  description: "Platinum credit card from IDFC First Bank with rewards on all spends. The IDFC First Bank Millennia Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
