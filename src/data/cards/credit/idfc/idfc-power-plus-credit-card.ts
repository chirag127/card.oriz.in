...
export const idfcPowerPlusCreditCard: CardData = {
  id: "idfc-power-plus-credit-card",
  name: "IDFC First Bank Power Plus Credit Card",
  tagline: "Platinum credit card from IDFC First Bank with rewards on all spends.",
  description: "Platinum credit card from IDFC First Bank with rewards on all spends. The IDFC First Bank Power Plus Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
