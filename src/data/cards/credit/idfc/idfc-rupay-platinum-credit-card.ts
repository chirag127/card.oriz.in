...
export const idfc_rupay_platinum_credit_card: CardData = {
  id: "idfc-rupay-platinum-credit-card",
  name: "IDFC FIRST Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card with UPI",
  description: "The IDFC FIRST Bank RuPay Platinum Credit Card is a lifetime-free domestic card with UPI.",
