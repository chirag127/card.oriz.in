...
export const hsbcBusinessCreditCard: CardData = {
  id: "hsbc-business-credit-card",
  name: "HSBC India Business Credit Card",
  tagline: "Corporate credit card from HSBC India with rewards on all spends.",
  description: "Corporate credit card from HSBC India with rewards on all spends. The HSBC India Business Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HSBC India",
  bankCode: "hsbc",
  network: "Visa",
  cardType: "credit",
