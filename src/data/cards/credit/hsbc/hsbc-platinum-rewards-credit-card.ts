...
export const hsbcPlatinumRewardsCreditCard: CardData = {
  id: "hsbc-platinum-rewards-credit-card",
  name: "HSBC India Platinum Rewards Credit Card",
  tagline: "Platinum credit card from HSBC India with rewards on all spends.",
  description: "Platinum credit card from HSBC India with rewards on all spends. The HSBC India Platinum Rewards Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HSBC India",
  bankCode: "hsbc",
  network: "Visa",
  cardType: "credit",
