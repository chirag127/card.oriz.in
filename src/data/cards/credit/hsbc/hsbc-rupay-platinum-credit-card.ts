...
export const hsbc_rupay_platinum_credit_card: CardData = {
  id: "hsbc-rupay-platinum-credit-card",
  name: "HSBC Bank RuPay Platinum Credit Card",
  tagline: "Lifetime free domestic card",
  description: "The HSBC RuPay Platinum Credit Card is a lifetime-free domestic card.",
  bank: "HSBC Bank",
  bankCode: "hsbc",
  network: "RuPay",
  cardType: "credit",
