...
export const hsbcGoldCreditCard: CardData = {
  id: "hsbc-gold-credit-card",
  name: "HSBC India Gold Credit Card",
  tagline: "Gold credit card from HSBC India with rewards on all spends.",
  description: "Gold credit card from HSBC India with rewards on all spends. The HSBC India Gold Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HSBC India",
  bankCode: "hsbc",
  network: "Visa",
  cardType: "credit",
