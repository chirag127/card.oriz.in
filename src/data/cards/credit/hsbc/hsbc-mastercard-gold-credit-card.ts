...
export const hsbc_mastercard_gold_credit_card: CardData = {
  id: "hsbc-mastercard-gold-credit-card",
  name: "HSBC Bank Mastercard Gold Credit Card",
  tagline: "Entry-level international card",
  description: "The HSBC Mastercard Gold Credit Card offers basic international features.",
  bank: "HSBC Bank",
  bankCode: "hsbc",
  network: "Mastercard",
  cardType: "credit",
