...
export const hsbcCorporateCreditCard: CardData = {
  id: "hsbc-corporate-credit-card",
  name: "HSBC India Corporate Credit Card",
  tagline: "Corporate credit card from HSBC India with rewards on all spends.",
  description: "Corporate credit card from HSBC India with rewards on all spends. The HSBC India Corporate Credit Card offers 2 RP per ₹100 and is best suited for Rewards, Cashback purposes.",
  bank: "HSBC India",
  bankCode: "hsbc",
  network: "Visa",
  cardType: "credit",
  ...
  insurance: {
    ...
    baggageCover: 0, conditions: ["Insurance applicable on card usage"], provider: "HSBC India",
  },
  benefits: [
    {
  ...
  rewardProgram: {
    name: "HSBC India Rewards", earnRate: "2 RP per ₹100", pointsPer100: 2, pointValue: 0.25,
  ...
  dataQuality: { status: "verified", verifiedFields: ["charges", "rewards", "eligibility"], unverifiedFields: [], sourceUrls: ["https://www.hsbc.com"], lastVerified: "2026-03-27" },
  customerCareNumber: "1800-XXX-XXXX",
  applyUrl: "https://www.hsbc.com/credit-cards",
