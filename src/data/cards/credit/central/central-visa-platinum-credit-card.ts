...
export const central_visa_platinum_credit_card: CardData = {
  id: "central-visa-platinum-credit-card",
  name: "Central Bank of India Visa Platinum Credit Card",
  tagline: "Enhanced rewards with domestic lounge access",
  description: "The Central Bank of India Visa Platinum Credit Card offers enhanced rewards, domestic lounge access, and comprehensive insurance coverage for everyday and occasional international spends.",
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Earn 2.5 reward points per Rs 100 on shopping, dining",
      valueStr: "2.5 RP per Rs 100",
      valueNum: 0,
  ...
  rewardProgram: {
    ...
    earnRate: "2.5 RP per Rs 100 on selected categories",
    pointsPer100: 2.5,
    pointValue: 0.25,
    effectiveCashbackPercent: 0.625,
    pointsExpiry: "2 years from date of accrual",
    bonusCategories: [{"category":"Shopping","multiplier":2.5,"description":"2.5 RP per Rs 100"},{"category":"Dining","multiplier":2.5,"description":"2.5 RP per Rs 100"}],
  ...
  milestoneBonuses: [
    {
      description: "Earn 1,500 bonus points on annual spend of Rs 2 Lakh",
      spendRequired: 200000,
      spendPeriod: "Annually",
      rewardStr: "1,500 bonus points",
      rewardNum: 1500,
    }
  ],
