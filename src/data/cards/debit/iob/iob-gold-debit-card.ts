...
export const iobGoldDebitCard: CardData = {
  id: 'iob-gold-debit-card-2', name: 'Indian Overseas Bank Gold Debit Card', tagline: 'gold card from Indian Overseas Bank', description: 'A gold card from Indian Overseas Bank.', bank: 'Indian Overseas Bank', bankCode: 'iob', network: 'RuPay', cardType: 'debit', tier: 'Gold', variant: 'Gold', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue', virtualCardAvailable: true,
