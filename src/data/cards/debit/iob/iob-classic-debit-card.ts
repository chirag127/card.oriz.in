...
export const iobClassicDebitCard: CardData = {
  id: 'iob-classic-debit-card', name: 'Indian Overseas Bank Classic Debit Card', tagline: 'A classic debit card from Indian Overseas Bank', description: 'The Indian Overseas Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'Indian Overseas Bank', bankCode: 'iob', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.iob.com', lastUpdated: '2026-03-27',
};