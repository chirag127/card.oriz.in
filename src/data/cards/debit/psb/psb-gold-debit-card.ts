...
export const psbGoldDebitCard: CardData = {
  id: 'psb-gold-debit-card-2', name: 'Punjab & Sind Bank Gold Debit Card', tagline: 'gold card from Punjab & Sind Bank', description: 'A gold card from Punjab & Sind Bank.', bank: 'Punjab & Sind Bank', bankCode: 'psb', network: 'RuPay', cardType: 'debit', tier: 'Gold', variant: 'Gold', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue', virtualCardAvailable: true,
