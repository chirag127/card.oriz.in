...
export const psbClassicDebitCard: CardData = {
  id: 'psb-classic-debit-card', name: 'Punjab & Sind Bank Classic Debit Card', tagline: 'A classic debit card from Punjab & Sind Bank', description: 'The Punjab & Sind Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'Punjab & Sind Bank', bankCode: 'psb', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.psb.com', lastUpdated: '2026-03-27',
};