...
export const auTitaniumDebitCard: CardData = {
  id: "au-titanium-debit-card",
  name: "AU Small Finance Bank Titanium Debit Card",
  tagline: "titanium debit card from AU Small Finance Bank.",
  description: "titanium debit card from AU Small Finance Bank.",
