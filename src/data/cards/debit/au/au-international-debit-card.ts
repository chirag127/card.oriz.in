...
export const auInternationalDebitCard: CardData = {
  id: "au-international-debit-card",
  name: "AU Small Finance Bank International Debit Card",
  tagline: "international debit card from AU Small Finance Bank.",
  description: "international debit card from AU Small Finance Bank.",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with AU Small Finance Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.au.com/debit-cards",
