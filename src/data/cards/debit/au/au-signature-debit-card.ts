...
export const auSignatureDebitCard: CardData = {
  id: "au-signature-debit-card",
  name: "AU Small Finance Bank Signature Debit Card",
  tagline: "signature debit card from AU Small Finance Bank.",
  description: "signature debit card from AU Small Finance Bank.",
