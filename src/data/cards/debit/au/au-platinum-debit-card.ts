...
export const auPlatinumDebitCard: CardData = {
  id: "au-platinum-debit-card",
  name: "AU Small Finance Bank Platinum Debit Card",
  tagline: "platinum debit card from AU Small Finance Bank.",
  description: "platinum debit card from AU Small Finance Bank.",
