...
export const federalTitaniumDebitCard: CardData = {
  id: "federal-titanium-debit-card",
  name: "Federal Bank Titanium Debit Card",
  tagline: "titanium debit card from Federal Bank.",
  description: "titanium debit card from Federal Bank.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "debit",
