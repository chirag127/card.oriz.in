...
export const federalSignatureDebitCard: CardData = {
  id: "federal-signature-debit-card",
  name: "Federal Bank Signature Debit Card",
  tagline: "signature debit card from Federal Bank.",
  description: "signature debit card from Federal Bank.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "debit",
