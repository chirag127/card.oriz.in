...
export const federalPlatinumDebitCard: CardData = {
  id: "federal-platinum-debit-card",
  name: "Federal Bank Platinum Debit Card",
  tagline: "platinum debit card from Federal Bank.",
  description: "platinum debit card from Federal Bank.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "debit",
