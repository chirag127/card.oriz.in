...
export const federalInternationalDebitCard: CardData = {
  id: "federal-international-debit-card",
  name: "Federal Bank International Debit Card",
  tagline: "international debit card from Federal Bank.",
  description: "international debit card from Federal Bank.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with Federal Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.federal.com/debit-cards",
