...
export const federalGoldDebitCard: CardData = {
  id: "federal-gold-debit-card",
  name: "Federal Bank Gold Debit Card",
  tagline: "gold debit card from Federal Bank.",
  description: "gold debit card from Federal Bank.",
  bank: "Federal Bank",
  bankCode: "federal",
  network: "Visa",
  cardType: "debit",
