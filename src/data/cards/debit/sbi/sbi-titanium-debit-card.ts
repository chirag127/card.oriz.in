...
export const sbiTitaniumDebitCard: CardData = {
  id: "sbi-titanium-debit-card",
  name: "SBI Card Titanium Debit Card",
  tagline: "titanium debit card from SBI Card.",
  description: "titanium debit card from SBI Card.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "debit",
