...
export const sbiInternationalDebitCard: CardData = {
  id: "sbi-international-debit-card",
  name: "SBI Card International Debit Card",
  tagline: "international debit card from SBI Card.",
  description: "international debit card from SBI Card.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with SBI Card required"] },
  charges: [
  ...
  applyUrl: "https://www.sbi.com/debit-cards",
