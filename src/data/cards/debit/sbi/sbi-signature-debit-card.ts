...
export const sbiSignatureDebitCard: CardData = {
  id: "sbi-signature-debit-card",
  name: "SBI Card Signature Debit Card",
  tagline: "signature debit card from SBI Card.",
  description: "signature debit card from SBI Card.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "debit",
