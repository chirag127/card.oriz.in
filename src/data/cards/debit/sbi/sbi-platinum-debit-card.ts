...
export const sbiPlatinumDebitCard: CardData = {
  id: "sbi-platinum-debit-card",
  name: "SBI Card Platinum Debit Card",
  tagline: "platinum debit card from SBI Card.",
  description: "platinum debit card from SBI Card.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "debit",
