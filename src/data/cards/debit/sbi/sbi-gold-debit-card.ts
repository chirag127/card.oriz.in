...
export const sbiGoldDebitCard: CardData = {
  id: "sbi-gold-debit-card",
  name: "SBI Card Gold Debit Card",
  tagline: "gold debit card from SBI Card.",
  description: "gold debit card from SBI Card.",
  bank: "SBI Card",
  bankCode: "sbi",
  network: "Visa",
  cardType: "debit",
