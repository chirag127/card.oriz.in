...
export const yesTitaniumDebitCard: CardData = {
  id: "yes-titanium-debit-card",
  name: "Yes Bank Titanium Debit Card",
  tagline: "titanium debit card from Yes Bank.",
  description: "titanium debit card from Yes Bank.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "debit",
