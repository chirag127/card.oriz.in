...
export const yesSignatureDebitCard: CardData = {
  id: "yes-signature-debit-card",
  name: "Yes Bank Signature Debit Card",
  tagline: "signature debit card from Yes Bank.",
  description: "signature debit card from Yes Bank.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "debit",
