...
export const yesPlatinumDebitCard: CardData = {
  id: "yes-platinum-debit-card",
  name: "Yes Bank Platinum Debit Card",
  tagline: "platinum debit card from Yes Bank.",
  description: "platinum debit card from Yes Bank.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "debit",
