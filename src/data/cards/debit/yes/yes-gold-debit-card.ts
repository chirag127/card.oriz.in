...
export const yesGoldDebitCard: CardData = {
  id: "yes-gold-debit-card",
  name: "Yes Bank Gold Debit Card",
  tagline: "gold debit card from Yes Bank.",
  description: "gold debit card from Yes Bank.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "debit",
