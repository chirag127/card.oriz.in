...
export const yesInternationalDebitCard: CardData = {
  id: "yes-international-debit-card",
  name: "Yes Bank International Debit Card",
  tagline: "international debit card from Yes Bank.",
  description: "international debit card from Yes Bank.",
  bank: "Yes Bank",
  bankCode: "yes",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with Yes Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.yes.com/debit-cards",
