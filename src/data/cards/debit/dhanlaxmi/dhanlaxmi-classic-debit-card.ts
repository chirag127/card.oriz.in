...
export const dhanlaxmiClassicDebitCard: CardData = {
  id: 'dhanlaxmi-classic-debit-card', name: 'Dhanlaxmi Bank Classic Debit Card', tagline: 'A classic debit card from Dhanlaxmi Bank', description: 'The Dhanlaxmi Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'Dhanlaxmi Bank', bankCode: 'dhanlaxmi', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
