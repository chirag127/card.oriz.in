...
export const hdfcGoldDebitCard: CardData = {
  id: "hdfc-gold-debit-card",
  name: "HDFC Bank Gold Debit Card",
  tagline: "gold debit card from HDFC Bank.",
  description: "gold debit card from HDFC Bank.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "debit",
