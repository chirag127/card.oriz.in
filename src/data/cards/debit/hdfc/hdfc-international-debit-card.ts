...
export const hdfcInternationalDebitCard: CardData = {
  id: "hdfc-international-debit-card",
  name: "HDFC Bank International Debit Card",
  tagline: "international debit card from HDFC Bank.",
  description: "international debit card from HDFC Bank.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with HDFC Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.hdfc.com/debit-cards",
