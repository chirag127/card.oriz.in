...
export const hdfcPlatinumDebitCard: CardData = {
  id: "hdfc-platinum-debit-card",
  name: "HDFC Bank Platinum Debit Card",
  tagline: "platinum debit card from HDFC Bank.",
  description: "platinum debit card from HDFC Bank.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "debit",
