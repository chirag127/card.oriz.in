...
export const hdfcTitaniumDebitCard: CardData = {
  id: "hdfc-titanium-debit-card",
  name: "HDFC Bank Titanium Debit Card",
  tagline: "titanium debit card from HDFC Bank.",
  description: "titanium debit card from HDFC Bank.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "debit",
