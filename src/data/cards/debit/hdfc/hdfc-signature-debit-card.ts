...
export const hdfcSignatureDebitCard: CardData = {
  id: "hdfc-signature-debit-card",
  name: "HDFC Bank Signature Debit Card",
  tagline: "signature debit card from HDFC Bank.",
  description: "signature debit card from HDFC Bank.",
  bank: "HDFC Bank",
  bankCode: "hdfc",
  network: "Visa",
  cardType: "debit",
