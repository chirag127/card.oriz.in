...
export const cubClassicDebitCard: CardData = {
  id: 'cub-classic-debit-card', name: 'City Union Bank Classic Debit Card', tagline: 'A classic debit card from City Union Bank', description: 'The City Union Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'City Union Bank', bankCode: 'cub', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
