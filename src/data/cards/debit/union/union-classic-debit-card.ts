...
export const unionClassicDebitCard: CardData = {
  id: "union-classic-debit-card",
  name: "Union Classic Debit Card",
  tagline: "Essential banking at great value",
  description: "The Union Classic Debit Card is a basic debit card offering essential banking features at an affordable annual fee. Perfect for everyday transactions.",
