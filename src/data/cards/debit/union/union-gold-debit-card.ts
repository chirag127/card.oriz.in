...
export const unionGoldDebitCard: CardData = {
  id: "union-gold-debit-card",
  name: "Union Gold Debit Card",
  tagline: "Premium gold debit with good value",
  description: "The Union Gold Debit Card offers enhanced transaction limits and premium features at a competitive annual fee. Ideal for everyday banking needs.",
  ...
  eligibility: {
    ...
    notes: ["Available to Union Bank account holders"],
  },
