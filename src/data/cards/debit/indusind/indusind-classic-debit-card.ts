...
export const indusindClassicDebitCard: CardData = {
  id: 'indusind-classic-debit-card', name: 'IndusInd Bank Classic Debit Card', tagline: 'A classic debit card from IndusInd Bank', description: 'The IndusInd Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'IndusInd Bank', bankCode: 'indusind', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.indusind.com', lastUpdated: '2026-03-27',
};