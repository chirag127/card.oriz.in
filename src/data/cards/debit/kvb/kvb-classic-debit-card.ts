...
export const kvbClassicDebitCard: CardData = {
  id: 'kvb-classic-debit-card', name: 'Karur Vysya Bank Classic Debit Card', tagline: 'A classic debit card from Karur Vysya Bank', description: 'The Karur Vysya Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'Karur Vysya Bank', bankCode: 'kvb', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.kvb.com', lastUpdated: '2026-03-27',
};