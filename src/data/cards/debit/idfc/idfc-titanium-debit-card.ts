...
export const idfcTitaniumDebitCard: CardData = {
  id: "idfc-titanium-debit-card",
  name: "IDFC First Bank Titanium Debit Card",
  tagline: "titanium debit card from IDFC First Bank.",
  description: "titanium debit card from IDFC First Bank.",
