...
export const idfcInternationalDebitCard: CardData = {
  id: "idfc-international-debit-card",
  name: "IDFC First Bank International Debit Card",
  tagline: "international debit card from IDFC First Bank.",
  description: "international debit card from IDFC First Bank.",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with IDFC First Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.idfc.com/debit-cards",
