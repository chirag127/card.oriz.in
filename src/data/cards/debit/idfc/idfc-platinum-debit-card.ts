...
export const idfcPlatinumDebitCard: CardData = {
  id: "idfc-platinum-debit-card",
  name: "IDFC First Bank Platinum Debit Card",
  tagline: "platinum debit card from IDFC First Bank.",
  description: "platinum debit card from IDFC First Bank.",
