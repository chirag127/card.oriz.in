...
export const idfcSignatureDebitCard: CardData = {
  id: "idfc-signature-debit-card",
  name: "IDFC First Bank Signature Debit Card",
  tagline: "signature debit card from IDFC First Bank.",
  description: "signature debit card from IDFC First Bank.",
