...
export const idfcGoldDebitCard: CardData = {
  id: "idfc-gold-debit-card",
  name: "IDFC First Bank Gold Debit Card",
  tagline: "gold debit card from IDFC First Bank.",
  description: "gold debit card from IDFC First Bank.",
