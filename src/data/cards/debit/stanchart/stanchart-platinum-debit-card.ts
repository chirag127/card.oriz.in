...
export const stanchartPlatinumDebitCard: CardData = {
  id: "stanchart-platinum-debit-card",
  name: "Standard Chartered Platinum Debit Card",
  tagline: "platinum debit card from Standard Chartered.",
  description: "platinum debit card from Standard Chartered.",
