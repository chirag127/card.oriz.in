...
export const stanchartTitaniumDebitCard: CardData = {
  id: "stanchart-titanium-debit-card",
  name: "Standard Chartered Titanium Debit Card",
  tagline: "titanium debit card from Standard Chartered.",
  description: "titanium debit card from Standard Chartered.",
  ...
  value: { highestValue: 2000, averageValue: 1000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 1000, tenYearNetValue: 10000, totalAnnualCharges: 590, totalAnnualBenefits: 1000, roiPercent: 169 },
  category: "standard",
