...
export const stanchartGoldDebitCard: CardData = {
  id: "stanchart-gold-debit-card",
  name: "Standard Chartered Gold Debit Card",
  tagline: "gold debit card from Standard Chartered.",
  description: "gold debit card from Standard Chartered.",
  ...
  value: { highestValue: 2000, averageValue: 1000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 1000, tenYearNetValue: 10000, totalAnnualCharges: 354, totalAnnualBenefits: 1000, roiPercent: 282 },
  category: "standard",
