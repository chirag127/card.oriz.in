...
export const stanchartSignatureDebitCard: CardData = {
  id: "stanchart-signature-debit-card",
  name: "Standard Chartered Signature Debit Card",
  tagline: "signature debit card from Standard Chartered.",
  description: "signature debit card from Standard Chartered.",
  ...
  charges: [
    ...
    { label: "Annual Fee", amount: 999, amountWithGst: 1179 },
  ],
  ...
  limits: { atmPerDay: 75000, posEcomPerDay: 200000, contactlessPerTxn: 5000, contactlessDailyLimit: 25000 },
  ...
  value: { highestValue: 2000, averageValue: 1000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 1000, tenYearNetValue: 10000, totalAnnualCharges: 1179, totalAnnualBenefits: 1000, roiPercent: 85 },
  category: "premium",
