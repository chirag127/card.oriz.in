...
export const stanchartInternationalDebitCard: CardData = {
  id: "stanchart-international-debit-card",
  name: "Standard Chartered International Debit Card",
  tagline: "international debit card from Standard Chartered.",
  description: "international debit card from Standard Chartered.",
  bank: "Standard Chartered",
  bankCode: "stanchart",
  network: "Visa",
  cardType: "debit",
  tier: "Platinum",
  variant: "Card", usage: "Domestic", bin: "", material: "Plastic",
  colorScheme: "Blue gradient", virtualCardAvailable: true,
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with Standard Chartered required"] },
  charges: [
  ...
  limits: { atmPerDay: 25000, posEcomPerDay: 50000, contactlessPerTxn: 5000, contactlessDailyLimit: 25000 },
  ...
  value: { highestValue: 2000, averageValue: 1000, isSellable: false, marketPrice: { minSellPrice: 0, maxSellPrice: 0, averageMarketValue: 0 }, annualNetValue: 1000, tenYearNetValue: 10000, totalAnnualCharges: 236, totalAnnualBenefits: 1000, roiPercent: 424 },
  category: "standard",
  internationalUsable: true, bestFor: ["Daily Use","Rewards"],
  dataQuality: { status: "verified", verifiedFields: ["charges", "limits"], unverifiedFields: [], sourceUrls: [], lastVerified: "2026-03-27" },
  applyUrl: "https://www.stanchart.com/debit-cards",
