...
export const axisGoldDebitCard: CardData = {
  id: "axis-gold-debit-card",
  name: "Axis Bank Gold Debit Card",
  tagline: "gold debit card from Axis Bank.",
  description: "gold debit card from Axis Bank.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "debit",
