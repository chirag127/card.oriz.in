...
export const axisInternationalDebitCard: CardData = {
  id: "axis-international-debit-card",
  name: "Axis Bank International Debit Card",
  tagline: "international debit card from Axis Bank.",
  description: "international debit card from Axis Bank.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with Axis Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.axis.com/debit-cards",
