...
export const axisTitaniumDebitCard: CardData = {
  id: "axis-titanium-debit-card",
  name: "Axis Bank Titanium Debit Card",
  tagline: "titanium debit card from Axis Bank.",
  description: "titanium debit card from Axis Bank.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "debit",
