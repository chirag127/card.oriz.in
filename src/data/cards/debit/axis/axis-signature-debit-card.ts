...
export const axisSignatureDebitCard: CardData = {
  id: "axis-signature-debit-card",
  name: "Axis Bank Signature Debit Card",
  tagline: "signature debit card from Axis Bank.",
  description: "signature debit card from Axis Bank.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "debit",
