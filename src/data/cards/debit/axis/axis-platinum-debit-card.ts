...
export const axisPlatinumDebitCard: CardData = {
  id: "axis-platinum-debit-card",
  name: "Axis Bank Platinum Debit Card",
  tagline: "platinum debit card from Axis Bank.",
  description: "platinum debit card from Axis Bank.",
  bank: "Axis Bank",
  bankCode: "axis",
  network: "Visa",
  cardType: "debit",
