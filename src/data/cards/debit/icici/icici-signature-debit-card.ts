...
export const iciciSignatureDebitCard: CardData = {
  id: "icici-signature-debit-card",
  name: "ICICI Bank Signature Debit Card",
  tagline: "signature debit card from ICICI Bank.",
  description: "signature debit card from ICICI Bank.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "debit",
