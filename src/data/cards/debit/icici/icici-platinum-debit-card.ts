...
export const iciciPlatinumDebitCard: CardData = {
  id: "icici-platinum-debit-card",
  name: "ICICI Bank Platinum Debit Card",
  tagline: "platinum debit card from ICICI Bank.",
  description: "platinum debit card from ICICI Bank.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "debit",
