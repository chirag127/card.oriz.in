...
export const iciciGoldDebitCard: CardData = {
  id: "icici-gold-debit-card",
  name: "ICICI Bank Gold Debit Card",
  tagline: "gold debit card from ICICI Bank.",
  description: "gold debit card from ICICI Bank.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "debit",
