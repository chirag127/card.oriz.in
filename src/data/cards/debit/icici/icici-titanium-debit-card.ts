...
export const iciciTitaniumDebitCard: CardData = {
  id: "icici-titanium-debit-card",
  name: "ICICI Bank Titanium Debit Card",
  tagline: "titanium debit card from ICICI Bank.",
  description: "titanium debit card from ICICI Bank.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "debit",
