...
export const iciciInternationalDebitCard: CardData = {
  id: "icici-international-debit-card",
  name: "ICICI Bank International Debit Card",
  tagline: "international debit card from ICICI Bank.",
  description: "international debit card from ICICI Bank.",
  bank: "ICICI Bank",
  bankCode: "icici",
  network: "Visa",
  cardType: "debit",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with ICICI Bank required"] },
  charges: [
  ...
  applyUrl: "https://www.icici.com/debit-cards",
