...
export const jkbGoldDebitCard: CardData = {
  id: 'jkb-gold-debit-card-2', name: 'Jammu & Kashmir Bank Gold Debit Card', tagline: 'gold card from Jammu & Kashmir Bank', description: 'A gold card from Jammu & Kashmir Bank.', bank: 'Jammu & Kashmir Bank', bankCode: 'jkb', network: 'RuPay', cardType: 'debit', tier: 'Gold', variant: 'Gold', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue', virtualCardAvailable: true,
