...
export const bomGoldDebitCard: CardData = {
  id: 'bom-gold-debit-card-2', name: 'Bank of Maharashtra Gold Debit Card', tagline: 'gold card from Bank of Maharashtra', description: 'A gold card from Bank of Maharashtra.', bank: 'Bank of Maharashtra', bankCode: 'bom', network: 'RuPay', cardType: 'debit', tier: 'Gold', variant: 'Gold', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue', virtualCardAvailable: true,
