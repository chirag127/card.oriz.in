...
export const bomClassicDebitCard: CardData = {
  id: 'bom-classic-debit-card', name: 'Bank of Maharashtra Classic Debit Card', tagline: 'A classic debit card from Bank of Maharashtra', description: 'The Bank of Maharashtra Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'Bank of Maharashtra', bankCode: 'bom', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
  ...
  applyUrl: 'https://www.bom.com', lastUpdated: '2026-03-27',
};