...
export const kotakGoldDebitCard: CardData = {
  id: "kotak-gold-debit-card",
  name: "Kotak Mahindra Bank Gold Debit Card",
  tagline: "gold debit card from Kotak Mahindra Bank.",
  description: "gold debit card from Kotak Mahindra Bank.",
