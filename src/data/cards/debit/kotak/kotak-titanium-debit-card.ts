...
export const kotakTitaniumDebitCard: CardData = {
  id: "kotak-titanium-debit-card",
  name: "Kotak Mahindra Bank Titanium Debit Card",
  tagline: "titanium debit card from Kotak Mahindra Bank.",
  description: "titanium debit card from Kotak Mahindra Bank.",
