...
export const kotakSignatureDebitCard: CardData = {
  id: "kotak-signature-debit-card",
  name: "Kotak Mahindra Bank Signature Debit Card",
  tagline: "signature debit card from Kotak Mahindra Bank.",
  description: "signature debit card from Kotak Mahindra Bank.",
