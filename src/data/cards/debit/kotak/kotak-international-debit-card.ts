...
export const kotakInternationalDebitCard: CardData = {
  id: "kotak-international-debit-card",
  name: "Kotak Mahindra Bank International Debit Card",
  tagline: "international debit card from Kotak Mahindra Bank.",
  description: "international debit card from Kotak Mahindra Bank.",
  ...
  eligibility: { employmentType: ["Salaried", "Self-Employed"], minAge: 18, maxAge: 65, existingAccountRequired: true, invitationOnly: false, notes: ["Account with Kotak Mahindra Bank required"] },
  charges: [
