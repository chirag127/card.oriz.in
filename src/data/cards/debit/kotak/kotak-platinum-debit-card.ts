...
export const kotakPlatinumDebitCard: CardData = {
  id: "kotak-platinum-debit-card",
  name: "Kotak Mahindra Bank Platinum Debit Card",
  tagline: "platinum debit card from Kotak Mahindra Bank.",
  description: "platinum debit card from Kotak Mahindra Bank.",
