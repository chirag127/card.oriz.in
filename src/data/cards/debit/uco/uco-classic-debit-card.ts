...
export const ucoClassicDebitCard: CardData = {
  id: 'uco-classic-debit-card', name: 'UCO Bank Classic Debit Card', tagline: 'A classic debit card from UCO Bank', description: 'The UCO Bank Classic Debit Card offers rewards and convenience for daily transactions.', bank: 'UCO Bank', bankCode: 'uco', network: 'Visa', cardType: 'debit', tier: 'Classic', variant: 'Classic', usage: 'Domestic', bin: '', material: 'Plastic', colorScheme: 'Blue gradient', virtualCardAvailable: true,
